...
namespace Pulumi.Vault.KeyMgmt
{
    ...
    /// </summary>
    [VaultResourceType("vault:keymgmt/distributeKey:DistributeKey")]
    public partial class DistributeKey : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DistributeKey(string name, DistributeKeyArgs args, CustomResourceOptions? options = null)
            : base("vault:keymgmt/distributeKey:DistributeKey", name, args ?? new DistributeKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DistributeKey(string name, Input<string> id, DistributeKeyState? state = null, CustomResourceOptions? options = null)
            : base("vault:keymgmt/distributeKey:DistributeKey", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DistributeKey Get(string name, Input<string> id, DistributeKeyState? state = null, CustomResourceOptions? options = null)
        {
            return new DistributeKey(name, id, state, options);
        }
    }

    public sealed class DistributeKeyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Specifies the name of the key to distribute to the given KMS provider.
        /// </summary>
        ...
        public DistributeKeyArgs()
        {
        }
        public static new DistributeKeyArgs Empty => new DistributeKeyArgs();
    }

    public sealed class DistributeKeyState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Specifies the name of the key to distribute to the given KMS provider.
        /// </summary>
        ...
        public DistributeKeyState()
        {
        }
        public static new DistributeKeyState Empty => new DistributeKeyState();
    }
}
