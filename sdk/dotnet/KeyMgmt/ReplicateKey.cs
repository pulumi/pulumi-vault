...
namespace Pulumi.Vault.KeyMgmt
{
    ...
    /// </summary>
    [VaultResourceType("vault:keymgmt/replicateKey:ReplicateKey")]
    public partial class ReplicateKey : global::Pulumi.CustomResource
    {
        ...
        public ReplicateKey(string name, ReplicateKeyArgs args, CustomResourceOptions? options = null)
            : base("vault:keymgmt/replicateKey:ReplicateKey", name, args ?? new ReplicateKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ReplicateKey(string name, Input<string> id, ReplicateKeyState? state = null, CustomResourceOptions? options = null)
            : base("vault:keymgmt/replicateKey:ReplicateKey", name, state, MakeResourceOptions(options, id))
        {
        }
