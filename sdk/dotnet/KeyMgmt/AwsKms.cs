...
namespace Pulumi.Vault.KeyMgmt
{
    ...
    /// </summary>
    [VaultResourceType("vault:keymgmt/awsKms:AwsKms")]
    public partial class AwsKms : global::Pulumi.CustomResource
    {
        ...
        public AwsKms(string name, AwsKmsArgs args, CustomResourceOptions? options = null)
            : base("vault:keymgmt/awsKms:AwsKms", name, args ?? new AwsKmsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AwsKms(string name, Input<string> id, AwsKmsState? state = null, CustomResourceOptions? options = null)
            : base("vault:keymgmt/awsKms:AwsKms", name, state, MakeResourceOptions(options, id))
        {
        }
