...
namespace Pulumi.Vault.KeyMgmt
{
    ...
    /// </summary>
    [VaultResourceType("vault:keymgmt/azureKms:AzureKms")]
    public partial class AzureKms : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public AzureKms(string name, AzureKmsArgs args, CustomResourceOptions? options = null)
            : base("vault:keymgmt/azureKms:AzureKms", name, args ?? new AzureKmsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AzureKms(string name, Input<string> id, AzureKmsState? state = null, CustomResourceOptions? options = null)
            : base("vault:keymgmt/azureKms:AzureKms", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AzureKms Get(string name, Input<string> id, AzureKmsState? state = null, CustomResourceOptions? options = null)
        {
            return new AzureKms(name, id, state, options);
        }
    }

    public sealed class AzureKmsArgs : global::Pulumi.ResourceArgs
    {
        [Input("credentialsWo")]
        ...
        public static new AzureKmsArgs Empty => new AzureKmsArgs();
    }

    public sealed class AzureKmsState : global::Pulumi.ResourceArgs
    {
        [Input("credentialsWo")]
        private InputMap<string>? _credentialsWo;
        ...
        public AzureKmsState()
        {
        }
        public static new AzureKmsState Empty => new AzureKmsState();
    }
}
