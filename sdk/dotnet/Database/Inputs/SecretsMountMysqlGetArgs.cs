...
namespace Pulumi.Vault.Database.Inputs
{
    ...
    public sealed class SecretsMountMysqlGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("allowedRoles")]
        ...
        public SecretsMountMysqlGetArgs()
        {
        }
        public static new SecretsMountMysqlGetArgs Empty => new SecretsMountMysqlGetArgs();
    }
}
