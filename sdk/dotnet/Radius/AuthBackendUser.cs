...
namespace Pulumi.Vault.Radius
{
    ...
    /// ```
    /// </summary>
    [VaultResourceType("vault:radius/authBackendUser:AuthBackendUser")]
    public partial class AuthBackendUser : global::Pulumi.CustomResource
    {
        ...
        public AuthBackendUser(string name, AuthBackendUserArgs args, CustomResourceOptions? options = null)
            : base("vault:radius/authBackendUser:AuthBackendUser", name, args ?? new AuthBackendUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthBackendUser(string name, Input<string> id, AuthBackendUserState? state = null, CustomResourceOptions? options = null)
            : base("vault:radius/authBackendUser:AuthBackendUser", name, state, MakeResourceOptions(options, id))
        {
        }
