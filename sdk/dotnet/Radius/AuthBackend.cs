...
namespace Pulumi.Vault.Radius
{
    ...
    /// ```
    /// </summary>
    [VaultResourceType("vault:radius/authBackend:AuthBackend")]
    public partial class AuthBackend : global::Pulumi.CustomResource
    {
        ...
        public AuthBackend(string name, AuthBackendArgs args, CustomResourceOptions? options = null)
            : base("vault:radius/authBackend:AuthBackend", name, args ?? new AuthBackendArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthBackend(string name, Input<string> id, AuthBackendState? state = null, CustomResourceOptions? options = null)
            : base("vault:radius/authBackend:AuthBackend", name, state, MakeResourceOptions(options, id))
        {
        }
