...
namespace Pulumi.Vault.Os
{
    ...
    /// ```
    /// </summary>
    [VaultResourceType("vault:os/secretBackendHost:SecretBackendHost")]
    public partial class SecretBackendHost : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SecretBackendHost(string name, SecretBackendHostArgs args, CustomResourceOptions? options = null)
            : base("vault:os/secretBackendHost:SecretBackendHost", name, args ?? new SecretBackendHostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecretBackendHost(string name, Input<string> id, SecretBackendHostState? state = null, CustomResourceOptions? options = null)
            : base("vault:os/secretBackendHost:SecretBackendHost", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SecretBackendHost Get(string name, Input<string> id, SecretBackendHostState? state = null, CustomResourceOptions? options = null)
        {
            return new SecretBackendHost(name, id, state, options);
        }
    }

    public sealed class SecretBackendHostArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The address of the host (IP address or hostname).
        /// </summary>
        ...
        public SecretBackendHostArgs()
        {
        }
        public static new SecretBackendHostArgs Empty => new SecretBackendHostArgs();
    }

    public sealed class SecretBackendHostState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The address of the host (IP address or hostname).
        /// </summary>
        ...
        public SecretBackendHostState()
        {
        }
        public static new SecretBackendHostState Empty => new SecretBackendHostState();
    }
}
