...
namespace Pulumi.Vault.Os
{
    ...
    /// </summary>
    [VaultResourceType("vault:os/secretBackendAccount:SecretBackendAccount")]
    public partial class SecretBackendAccount : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SecretBackendAccount(string name, SecretBackendAccountArgs args, CustomResourceOptions? options = null)
            : base("vault:os/secretBackendAccount:SecretBackendAccount", name, args ?? new SecretBackendAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecretBackendAccount(string name, Input<string> id, SecretBackendAccountState? state = null, CustomResourceOptions? options = null)
            : base("vault:os/secretBackendAccount:SecretBackendAccount", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SecretBackendAccount Get(string name, Input<string> id, SecretBackendAccountState? state = null, CustomResourceOptions? options = null)
        {
            return new SecretBackendAccount(name, id, state, options);
        }
    }

    public sealed class SecretBackendAccountArgs : global::Pulumi.ResourceArgs
    {
        ...
        public SecretBackendAccountArgs()
        {
        }
        public static new SecretBackendAccountArgs Empty => new SecretBackendAccountArgs();
    }

    public sealed class SecretBackendAccountState : global::Pulumi.ResourceArgs
    {
        [Input("customMetadata")]
        private InputMap<string>? _customMetadata;
        ...
        public SecretBackendAccountState()
        {
        }
        public static new SecretBackendAccountState Empty => new SecretBackendAccountState();
    }
}
