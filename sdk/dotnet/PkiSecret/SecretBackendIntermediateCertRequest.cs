...
namespace Pulumi.Vault.PkiSecret
{
    ...
    public partial class SecretBackendIntermediateCertRequest : Pulumi.CustomResource
    {
        ...
        public SecretBackendIntermediateCertRequest(string name, SecretBackendIntermediateCertRequestArgs args, CustomResourceOptions? options = null)
            : base("vault:pkiSecret/secretBackendIntermediateCertRequest:SecretBackendIntermediateCertRequest", name, args ?? ResourceArgs.Empty, MakeResourceOptions(options, ""))
        {
        }
