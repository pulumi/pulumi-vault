...
namespace Pulumi.Vault.PkiExternalCa
{
    ...
    /// </summary>
    [VaultResourceType("vault:pkiexternalca/secretBackendOrderCertificate:SecretBackendOrderCertificate")]
    public partial class SecretBackendOrderCertificate : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SecretBackendOrderCertificate(string name, SecretBackendOrderCertificateArgs args, CustomResourceOptions? options = null)
            : base("vault:pkiexternalca/secretBackendOrderCertificate:SecretBackendOrderCertificate", name, args ?? new SecretBackendOrderCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SecretBackendOrderCertificate(string name, Input<string> id, SecretBackendOrderCertificateState? state = null, CustomResourceOptions? options = null)
            : base("vault:pkiexternalca/secretBackendOrderCertificate:SecretBackendOrderCertificate", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SecretBackendOrderCertificate Get(string name, Input<string> id, SecretBackendOrderCertificateState? state = null, CustomResourceOptions? options = null)
        {
            return new SecretBackendOrderCertificate(name, id, state, options);
        }
    }

    public sealed class SecretBackendOrderCertificateArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The path where the PKI External CA secret backend is mounted.
        /// </summary>
        ...
        public SecretBackendOrderCertificateArgs()
        {
        }
        public static new SecretBackendOrderCertificateArgs Empty => new SecretBackendOrderCertificateArgs();
    }

    public sealed class SecretBackendOrderCertificateState : global::Pulumi.ResourceArgs
    {
        [Input("caChains")]
        ...
        public SecretBackendOrderCertificateState()
        {
        }
        public static new SecretBackendOrderCertificateState Empty => new SecretBackendOrderCertificateState();
    }
}
