...
namespace Pulumi.Vault.Spiffe
{
    ...
    /// ```
    /// </summary>
    [VaultResourceType("vault:spiffe/authBackendRole:AuthBackendRole")]
    public partial class AuthBackendRole : global::Pulumi.CustomResource
    {
        ...
        public AuthBackendRole(string name, AuthBackendRoleArgs args, CustomResourceOptions? options = null)
            : base("vault:spiffe/authBackendRole:AuthBackendRole", name, args ?? new AuthBackendRoleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthBackendRole(string name, Input<string> id, AuthBackendRoleState? state = null, CustomResourceOptions? options = null)
            : base("vault:spiffe/authBackendRole:AuthBackendRole", name, state, MakeResourceOptions(options, id))
        {
        }
