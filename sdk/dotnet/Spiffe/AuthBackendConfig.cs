...
namespace Pulumi.Vault.Spiffe
{
    ...
    /// ```
    /// </summary>
    [VaultResourceType("vault:spiffe/authBackendConfig:AuthBackendConfig")]
    public partial class AuthBackendConfig : global::Pulumi.CustomResource
    {
        ...
        public AuthBackendConfig(string name, AuthBackendConfigArgs args, CustomResourceOptions? options = null)
            : base("vault:spiffe/authBackendConfig:AuthBackendConfig", name, args ?? new AuthBackendConfigArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AuthBackendConfig(string name, Input<string> id, AuthBackendConfigState? state = null, CustomResourceOptions? options = null)
            : base("vault:spiffe/authBackendConfig:AuthBackendConfig", name, state, MakeResourceOptions(options, id))
        {
        }
