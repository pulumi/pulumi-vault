...
public final class SecretBackendConfigUrlsArgs extends com.pulumi.resources.ResourceArgs {

    public static final SecretBackendConfigUrlsArgs Empty = new SecretBackendConfigUrlsArgs();
    ...
    private SecretBackendConfigUrlsArgs() {}
    ...
    public static Builder builder(SecretBackendConfigUrlsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecretBackendConfigUrlsArgs();
        }

        public Builder(SecretBackendConfigUrlsArgs defaults) {
            $ = new SecretBackendConfigUrlsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SecretBackendConfigUrlsArgs build() {
            if ($.backend == null) {
                throw new MissingRequiredPropertyException("SecretBackendConfigUrlsArgs", "backend");
            }
            return $;
        }
    }
