...
public final class SecretsMountMongodb {
    ...
    public static final class Builder {
        ...
        public Builder verifyConnection(@Nullable Boolean verifyConnection) {
            ...
            return new SecretsMountMongodb(allowedRoles, connectionUrl, data, maxConnectionLifetime, maxIdleConnections, maxOpenConnections, name, password, pluginName, rootRotationStatements, username, usernameTemplate, verifyConnection);
        }
    }
}
