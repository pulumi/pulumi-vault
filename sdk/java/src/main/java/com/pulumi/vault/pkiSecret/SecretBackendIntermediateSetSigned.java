...
public class SecretBackendIntermediateSetSigned extends com.pulumi.resources.CustomResource {
    ...
    private SecretBackendIntermediateSetSigned(java.lang.String name, Output<java.lang.String> id, @Nullable SecretBackendIntermediateSetSignedState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static SecretBackendIntermediateSetSigned get(java.lang.String name, Output<java.lang.String> id, @Nullable SecretBackendIntermediateSetSignedState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
