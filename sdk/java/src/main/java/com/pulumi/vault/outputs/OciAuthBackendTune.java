...
@CustomType
public final class OciAuthBackendTune {
    /**
    ...
    public static Builder builder(OciAuthBackendTune defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tokenType;
        public Builder() {}
        public Builder(OciAuthBackendTune defaults) {
        ...
        public OciAuthBackendTune build() {
            final var _resultValue = new OciAuthBackendTune();
