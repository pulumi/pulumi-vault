...
public class AuthBackendRole extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="bindSecretId", type=Boolean.class, parameters={})
     ...
     * 
     */
    @Export(name="secretIdBoundCidrs", type=List.class, parameters={String.class})
     ...
     * 
     */
    @Export(name="secretIdNumUses", type=Integer.class, parameters={})
     ...
     * 
     */
    @Export(name="secretIdTtl", type=Integer.class, parameters={})
    ...
    public AuthBackendRole(String name, AuthBackendRoleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:appRole/authBackendRole:AuthBackendRole", name, args == null ? AuthBackendRoleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private AuthBackendRole(String name, Output<String> id, @Nullable AuthBackendRoleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:appRole/authBackendRole:AuthBackendRole", name, state, makeResourceOptions(options, id));
    }
