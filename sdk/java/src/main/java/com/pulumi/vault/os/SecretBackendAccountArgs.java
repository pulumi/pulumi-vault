...
public final class SecretBackendAccountArgs extends com.pulumi.resources.ResourceArgs {

    public static final SecretBackendAccountArgs Empty = new SecretBackendAccountArgs();
    ...
    private SecretBackendAccountArgs() {}

    private SecretBackendAccountArgs(SecretBackendAccountArgs $) {
    ...
    public static Builder builder(SecretBackendAccountArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecretBackendAccountArgs();
        }

        public Builder(SecretBackendAccountArgs defaults) {
            $ = new SecretBackendAccountArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SecretBackendAccountArgs build() {
            if ($.host == null) {
                throw new MissingRequiredPropertyException("SecretBackendAccountArgs", "host");
            }
            if ($.mount == null) {
                throw new MissingRequiredPropertyException("SecretBackendAccountArgs", "mount");
            }
            if ($.passwordWo == null) {
                throw new MissingRequiredPropertyException("SecretBackendAccountArgs", "passwordWo");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("SecretBackendAccountArgs", "username");
            }
            return $;
        }
    }
