...
public class OidcScope extends com.pulumi.resources.CustomResource {
     ...
     */
    public OidcScope(java.lang.String name) {
     ...
     */
    public OidcScope(java.lang.String name, @Nullable OidcScopeArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public OidcScope(java.lang.String name, @Nullable OidcScopeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:identity/oidcScope:OidcScope", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private OidcScope(java.lang.String name, Output<java.lang.String> id, @Nullable OidcScopeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:identity/oidcScope:OidcScope", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static OidcScope get(java.lang.String name, Output<java.lang.String> id, @Nullable OidcScopeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
