...
public final class SyncConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final SyncConfigArgs Empty = new SyncConfigArgs();
    ...
    private SyncConfigArgs() {}

    private SyncConfigArgs(SyncConfigArgs $) {
    ...
    public static Builder builder(SyncConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SyncConfigArgs defaults) {
            $ = new SyncConfigArgs(Objects.requireNonNull(defaults));
        }
