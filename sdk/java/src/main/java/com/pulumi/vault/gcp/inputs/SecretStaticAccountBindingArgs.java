...
public final class SecretStaticAccountBindingArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public SecretStaticAccountBindingArgs build() {
            if ($.resource == null) {
                throw new MissingRequiredPropertyException("SecretStaticAccountBindingArgs", "resource");
            }
            if ($.roles == null) {
                throw new MissingRequiredPropertyException("SecretStaticAccountBindingArgs", "roles");
            }
            return $;
        }
    }
