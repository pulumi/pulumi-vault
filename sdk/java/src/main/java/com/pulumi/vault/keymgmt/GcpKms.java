...
import com.pulumi.vault.keymgmt.inputs.GcpKmsState;
 ...
 * 
 */
@ResourceType(type="vault:keymgmt/gcpKms:GcpKms")
public class GcpKms extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public GcpKms(java.lang.String name) {
        this(name, GcpKmsArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public GcpKms(java.lang.String name, GcpKmsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public GcpKms(java.lang.String name, GcpKmsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:keymgmt/gcpKms:GcpKms", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private GcpKms(java.lang.String name, Output<java.lang.String> id, @Nullable GcpKmsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:keymgmt/gcpKms:GcpKms", name, state, makeResourceOptions(options, id), false);
    }

    private static GcpKmsArgs makeArgs(GcpKmsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? GcpKmsArgs.Empty : args;
    }
     ...
     */
    public static GcpKms get(java.lang.String name, Output<java.lang.String> id, @Nullable GcpKmsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new GcpKms(name, id, state, options);
    }
}
