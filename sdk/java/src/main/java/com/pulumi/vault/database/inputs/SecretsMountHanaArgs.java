...
public final class SecretsMountHanaArgs extends com.pulumi.resources.ResourceArgs {

    public static final SecretsMountHanaArgs Empty = new SecretsMountHanaArgs();
    ...
    private SecretsMountHanaArgs() {}

    private SecretsMountHanaArgs(SecretsMountHanaArgs $) {
    ...
    public static Builder builder(SecretsMountHanaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecretsMountHanaArgs();
        }

        public Builder(SecretsMountHanaArgs defaults) {
            $ = new SecretsMountHanaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SecretsMountHanaArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("SecretsMountHanaArgs", "name");
            }
            return $;
        }
    }
