...
public final class ScepAuthBackendRoleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(ScepAuthBackendRoleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public ScepAuthBackendRoleArgs build() {
            if ($.authType == null) {
                throw new MissingRequiredPropertyException("ScepAuthBackendRoleArgs", "authType");
            }
            return $;
        }
    }
