...
public final class BackendConfigCmpv2Args extends com.pulumi.resources.ResourceArgs {

    public static final BackendConfigCmpv2Args Empty = new BackendConfigCmpv2Args();
    ...
    private BackendConfigCmpv2Args() {}

    private BackendConfigCmpv2Args(BackendConfigCmpv2Args $) {
    ...
    public static Builder builder(BackendConfigCmpv2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BackendConfigCmpv2Args();
        }

        public Builder(BackendConfigCmpv2Args defaults) {
            $ = new BackendConfigCmpv2Args(Objects.requireNonNull(defaults));
        }
        ...
        public BackendConfigCmpv2Args build() {
            if ($.backend == null) {
                throw new MissingRequiredPropertyException("BackendConfigCmpv2Args", "backend");
            }
            return $;
        }
    }
