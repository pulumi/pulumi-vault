...
public class UiCustomMessage extends com.pulumi.resources.CustomResource {
     ...
     */
    public UiCustomMessage(String name) {
     ...
     */
    public static UiCustomMessage get(String name, Output<String> id, @Nullable UiCustomMessageState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
