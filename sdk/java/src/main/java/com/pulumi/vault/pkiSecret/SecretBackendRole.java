...
public class SecretBackendRole extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="noStoreMetadata", refs={Boolean.class}, tree="[0]")
    private Output</* @Nullable */ Boolean> noStoreMetadata;
     ...
     * 
     */
    public Output<Optional<Boolean>> noStoreMetadata() {
        return Codegen.optional(this.noStoreMetadata);
    }
    /**
     ...
     * 
     */
    @Export(name="serialNumberSource", refs={String.class}, tree="[0]")
     ...
     * 
     */
    public Output<String> serialNumberSource() {
        return this.serialNumberSource;
    }
    /**
    ...
    public SecretBackendRole(java.lang.String name, SecretBackendRoleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:pkiSecret/secretBackendRole:SecretBackendRole", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private SecretBackendRole(java.lang.String name, Output<java.lang.String> id, @Nullable SecretBackendRoleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:pkiSecret/secretBackendRole:SecretBackendRole", name, state, makeResourceOptions(options, id), false);
    }
