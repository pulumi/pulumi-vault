...
public final class OciAuthBackendState extends com.pulumi.resources.ResourceArgs {

    public static final OciAuthBackendState Empty = new OciAuthBackendState();
     ...
     * 
     */
    @Import(name="homeTenancyId")
    private @Nullable Output<String> homeTenancyId;

    /**
     * @return The Tenancy OCID of your OCI account.
     * 
     */
    public Optional<Output<String>> homeTenancyId() {
        return Optional.ofNullable(this.homeTenancyId);
    }
    ...
    private OciAuthBackendState() {}

    private OciAuthBackendState(OciAuthBackendState $) {
    ...
    public static Builder builder(OciAuthBackendState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OciAuthBackendState();
        }

        public Builder(OciAuthBackendState defaults) {
            $ = new OciAuthBackendState(Objects.requireNonNull(defaults));
        }

        /**
         * @param accessor The accessor of the auth backend
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder homeTenancyId(@Nullable Output<String> homeTenancyId) {
        ...
        public OciAuthBackendState build() {
            return $;
        }
    }
