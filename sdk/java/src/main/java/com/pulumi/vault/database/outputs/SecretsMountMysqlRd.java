...
@CustomType
public final class SecretsMountMysqlRd {
    /**
    ...
    public static Builder builder(SecretsMountMysqlRd defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SecretsMountMysqlRd defaults) {
        ...
        public Builder verifyConnection(@Nullable Boolean verifyConnection) {
            ...
            return new SecretsMountMysqlRd(allowedRoles, connectionUrl, data, maxConnectionLifetime, maxIdleConnections, maxOpenConnections, name, password, pluginName, rootRotationStatements, username, usernameTemplate, verifyConnection);
        }
    }
}
