...
public final class SecretBackendConnectionMysqlLegacy {
    ...
    public static final class Builder {
        ...
        public Builder usernameTemplate(@Nullable String usernameTemplate) {
            ...
            return new SecretBackendConnectionMysqlLegacy(connectionUrl, maxConnectionLifetime, maxIdleConnections, maxOpenConnections, password, username, usernameTemplate);
        }
    }
}
