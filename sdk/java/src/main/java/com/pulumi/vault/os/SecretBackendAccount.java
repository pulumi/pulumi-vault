...
import com.pulumi.vault.os.inputs.SecretBackendAccountState;
 ...
 * 
 */
@ResourceType(type="vault:os/secretBackendAccount:SecretBackendAccount")
public class SecretBackendAccount extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public SecretBackendAccount(java.lang.String name) {
        this(name, SecretBackendAccountArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public SecretBackendAccount(java.lang.String name, SecretBackendAccountArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SecretBackendAccount(java.lang.String name, SecretBackendAccountArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:os/secretBackendAccount:SecretBackendAccount", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SecretBackendAccount(java.lang.String name, Output<java.lang.String> id, @Nullable SecretBackendAccountState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:os/secretBackendAccount:SecretBackendAccount", name, state, makeResourceOptions(options, id), false);
    }

    private static SecretBackendAccountArgs makeArgs(SecretBackendAccountArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SecretBackendAccountArgs.Empty : args;
    }
     ...
     */
    public static SecretBackendAccount get(java.lang.String name, Output<java.lang.String> id, @Nullable SecretBackendAccountState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new SecretBackendAccount(name, id, state, options);
    }
}
