...
import com.pulumi.vault.keymgmt.inputs.AzureKmsState;
 ...
 * 
 */
@ResourceType(type="vault:keymgmt/azureKms:AzureKms")
public class AzureKms extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public AzureKms(java.lang.String name) {
        this(name, AzureKmsArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AzureKms(java.lang.String name, AzureKmsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AzureKms(java.lang.String name, AzureKmsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:keymgmt/azureKms:AzureKms", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AzureKms(java.lang.String name, Output<java.lang.String> id, @Nullable AzureKmsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:keymgmt/azureKms:AzureKms", name, state, makeResourceOptions(options, id), false);
    }

    private static AzureKmsArgs makeArgs(AzureKmsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AzureKmsArgs.Empty : args;
    }
     ...
     */
    public static AzureKms get(java.lang.String name, Output<java.lang.String> id, @Nullable AzureKmsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new AzureKms(name, id, state, options);
    }
}
