...
public final class SecretsMountArgs extends com.pulumi.resources.ResourceArgs {

    public static final SecretsMountArgs Empty = new SecretsMountArgs();
    ...
    public static Builder builder(SecretsMountArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecretsMountArgs();
        }

        public Builder(SecretsMountArgs defaults) {
            $ = new SecretsMountArgs(Objects.requireNonNull(defaults));
        }
