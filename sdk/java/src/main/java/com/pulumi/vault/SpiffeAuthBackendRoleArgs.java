...
public final class SpiffeAuthBackendRoleArgs extends com.pulumi.resources.ResourceArgs {

    public static final SpiffeAuthBackendRoleArgs Empty = new SpiffeAuthBackendRoleArgs();
     ...
     * 
     */
    @Import(name="workloadIdPatterns")
    private @Nullable Output<List<String>> workloadIdPatterns;
     ...
     * 
     */
    public Optional<Output<List<String>>> workloadIdPatterns() {
        return Optional.ofNullable(this.workloadIdPatterns);
    }

    private SpiffeAuthBackendRoleArgs() {}

    private SpiffeAuthBackendRoleArgs(SpiffeAuthBackendRoleArgs $) {
        ...
        this.workloadIdPatterns = $.workloadIdPatterns;
    }

    public static Builder builder() {
        return new Builder();
    }
    public static Builder builder(SpiffeAuthBackendRoleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SpiffeAuthBackendRoleArgs();
        }

        public Builder(SpiffeAuthBackendRoleArgs defaults) {
            $ = new SpiffeAuthBackendRoleArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param displayName The human-readable name for tokens issued when
         * authenticating against the role. Defaults to the value provided for `mount`.
         * 
         * @return builder
         * 
        ...
        /**
         * @param name Name of the SPIFFE auth role.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param workloadIdPatterns A comma separated list of patterns that match an
         * incoming workload ID within the SVID document presented by the client.
         * 
         * @return builder
         * 
         */
        public Builder workloadIdPatterns(@Nullable Output<List<String>> workloadIdPatterns) {
            $.workloadIdPatterns = workloadIdPatterns;
            return this;
        }
         ...
         * 
         */
        public Builder workloadIdPatterns(List<String> workloadIdPatterns) {
            return workloadIdPatterns(Output.of(workloadIdPatterns));
        }
         ...
         * 
         */
        public Builder workloadIdPatterns(String... workloadIdPatterns) {
            return workloadIdPatterns(List.of(workloadIdPatterns));
        }

        public SpiffeAuthBackendRoleArgs build() {
            if ($.mount == null) {
                throw new MissingRequiredPropertyException("SpiffeAuthBackendRoleArgs", "mount");
            }
            return $;
        }
    }
