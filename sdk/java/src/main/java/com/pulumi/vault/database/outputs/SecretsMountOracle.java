...
public final class SecretsMountOracle {
    ...
    public static final class Builder {
        ...
        public Builder verifyConnection(@Nullable Boolean verifyConnection) {
            ...
            return new SecretsMountOracle(allowedRoles, connectionUrl, data, maxConnectionLifetime, maxIdleConnections, maxOpenConnections, name, password, pluginName, rootRotationStatements, username, usernameTemplate, verifyConnection);
        }
    }
}
