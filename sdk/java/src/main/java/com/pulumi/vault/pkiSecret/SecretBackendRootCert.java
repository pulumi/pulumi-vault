...
public class SecretBackendRootCert extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="jksPrivateKeyAlias", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> jksPrivateKeyAlias;
     ...
     * 
     */
    public Output<Optional<String>> jksPrivateKeyAlias() {
        return Codegen.optional(this.jksPrivateKeyAlias);
    }
    /**
