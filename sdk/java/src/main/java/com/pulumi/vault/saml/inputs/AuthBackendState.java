...
public final class AuthBackendState extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="acsUrls")
    private @Nullable Output<List<String>> acsUrls;
     ...
     * 
     */
    public Optional<Output<List<String>>> acsUrls() {
        return Optional.ofNullable(this.acsUrls);
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder acsUrls(@Nullable Output<List<String>> acsUrls) {
            $.acsUrls = acsUrls;
            return this;
        }
