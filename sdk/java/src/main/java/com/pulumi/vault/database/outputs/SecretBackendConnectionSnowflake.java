...
public final class SecretBackendConnectionSnowflake {
    ...
    public static final class Builder {
        ...
        public Builder usernameTemplate(@Nullable String usernameTemplate) {
            ...
            return new SecretBackendConnectionSnowflake(connectionUrl, maxConnectionLifetime, maxIdleConnections, maxOpenConnections, password, username, usernameTemplate);
        }
    }
}
