...
import com.pulumi.vault.AgentRegistrationArgs;
import com.pulumi.vault.Utilities;
import com.pulumi.vault.inputs.AgentRegistrationState;
 ...
 * 
 */
@ResourceType(type="vault:index/agentRegistration:AgentRegistration")
public class AgentRegistration extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="ceilingPolicies", refs={List.class,String.class}, tree="[0,1]")
    private Output<List<String>> ceilingPolicies;

    /**
     * @return A list of policy names that define the maximum permissions this agent can obtain. These policies act as a ceiling - the agent cannot obtain permissions beyond what these policies allow, even if the entity or token policies would grant more permissions. By default, Vault applies a default ceiling policy unless `noDefaultCeilingPolicy` is set to `true`.
     * 
     */
    public Output<List<String>> ceilingPolicies() {
        return this.ceilingPolicies;
    }
    /**
     ...
     * 
     */
    @Export(name="noDefaultCeilingPolicy", refs={Boolean.class}, tree="[0]")
    private Output<Boolean> noDefaultCeilingPolicy;
     ...
     * 
     */
    public Output<Boolean> noDefaultCeilingPolicy() {
        return this.noDefaultCeilingPolicy;
    }
    /**
     ...
     */
    public AgentRegistration(java.lang.String name) {
        this(name, AgentRegistrationArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AgentRegistration(java.lang.String name, AgentRegistrationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AgentRegistration(java.lang.String name, AgentRegistrationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:index/agentRegistration:AgentRegistration", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AgentRegistration(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistrationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:index/agentRegistration:AgentRegistration", name, state, makeResourceOptions(options, id), false);
    }

    private static AgentRegistrationArgs makeArgs(AgentRegistrationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AgentRegistrationArgs.Empty : args;
    }
     ...
     */
    public static AgentRegistration get(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistrationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
