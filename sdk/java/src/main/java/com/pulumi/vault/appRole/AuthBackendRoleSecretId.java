...
public class AuthBackendRoleSecretId extends com.pulumi.resources.CustomResource {
     ...
     */
    public AuthBackendRoleSecretId(java.lang.String name) {
     ...
     */
    public AuthBackendRoleSecretId(java.lang.String name, AuthBackendRoleSecretIdArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AuthBackendRoleSecretId(java.lang.String name, AuthBackendRoleSecretIdArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:appRole/authBackendRoleSecretId:AuthBackendRoleSecretId", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AuthBackendRoleSecretId(java.lang.String name, Output<java.lang.String> id, @Nullable AuthBackendRoleSecretIdState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:appRole/authBackendRoleSecretId:AuthBackendRoleSecretId", name, state, makeResourceOptions(options, id), false);
    }

    private static AuthBackendRoleSecretIdArgs makeArgs(AuthBackendRoleSecretIdArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AuthBackendRoleSecretIdArgs.Empty : args;
    }
     ...
     */
    public static AuthBackendRoleSecretId get(java.lang.String name, Output<java.lang.String> id, @Nullable AuthBackendRoleSecretIdState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
