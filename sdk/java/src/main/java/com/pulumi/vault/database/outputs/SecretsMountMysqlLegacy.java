...
@CustomType
public final class SecretsMountMysqlLegacy {
    /**
    ...
    public static Builder builder(SecretsMountMysqlLegacy defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SecretsMountMysqlLegacy defaults) {
        ...
        public Builder verifyConnection(@Nullable Boolean verifyConnection) {
            this.verifyConnection = verifyConnection;
            return this;
        }        public SecretsMountMysqlLegacy build() {
            return new SecretsMountMysqlLegacy(allowedRoles, connectionUrl, data, maxConnectionLifetime, maxIdleConnections, maxOpenConnections, name, password, pluginName, rootRotationStatements, username, usernameTemplate, verifyConnection);
        }
    }
}
