 ...
 * `awsSecretAccessKeyWo`) to avoid storing those values in state. Protect
...
public class RaftSnapshotAgentConfig extends com.pulumi.resources.CustomResource {
    ...
    private Output<Integer> secretsWoVersion;
     ...
     * 
     */
    public Output<Integer> secretsWoVersion() {
