...
public class QuotaLeaseCount extends com.pulumi.resources.CustomResource {
     ...
     */
    public QuotaLeaseCount(java.lang.String name) {
     ...
     */
    public QuotaLeaseCount(java.lang.String name, QuotaLeaseCountArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public QuotaLeaseCount(java.lang.String name, QuotaLeaseCountArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:index/quotaLeaseCount:QuotaLeaseCount", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private QuotaLeaseCount(java.lang.String name, Output<java.lang.String> id, @Nullable QuotaLeaseCountState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("vault:index/quotaLeaseCount:QuotaLeaseCount", name, state, makeResourceOptions(options, id), false);
    }

    private static QuotaLeaseCountArgs makeArgs(QuotaLeaseCountArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? QuotaLeaseCountArgs.Empty : args;
    }
     ...
     */
    public static QuotaLeaseCount get(java.lang.String name, Output<java.lang.String> id, @Nullable QuotaLeaseCountState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
