...
@CustomType
public final class SecretsMountSnowflake {
    /**
    ...
    public static Builder builder(SecretsMountSnowflake defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SecretsMountSnowflake defaults) {
        ...
        public Builder verifyConnection(@Nullable Boolean verifyConnection) {
            this.verifyConnection = verifyConnection;
            return this;
        }        public SecretsMountSnowflake build() {
            return new SecretsMountSnowflake(allowedRoles, connectionUrl, data, maxConnectionLifetime, maxIdleConnections, maxOpenConnections, name, password, pluginName, rootRotationStatements, username, usernameTemplate, verifyConnection);
        }
    }
}
