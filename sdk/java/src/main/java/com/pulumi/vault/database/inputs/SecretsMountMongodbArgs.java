...
public final class SecretsMountMongodbArgs extends com.pulumi.resources.ResourceArgs {

    public static final SecretsMountMongodbArgs Empty = new SecretsMountMongodbArgs();
    ...
    public static Builder builder(SecretsMountMongodbArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecretsMountMongodbArgs();
        }

        public Builder(SecretsMountMongodbArgs defaults) {
            $ = new SecretsMountMongodbArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SecretsMountMongodbArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("SecretsMountMongodbArgs", "name");
            }
            return $;
        }
    }
