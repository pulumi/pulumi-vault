    ...
    public static final class Builder {
        ...
        public SecretBackendStaticRoleArgs build() {
            if ($.applicationObjectId == null) {
                throw new MissingRequiredPropertyException("SecretBackendStaticRoleArgs", "applicationObjectId");
            }
            if ($.backend == null) {
                throw new MissingRequiredPropertyException("SecretBackendStaticRoleArgs", "backend");
            }
            if ($.role == null) {
                throw new MissingRequiredPropertyException("SecretBackendStaticRoleArgs", "role");
            }
            return $;
        }
    }
