...
func NewSecretBackendRootCert(ctx *pulumi.Context,
	...
	inputs["serial"] = nil
	s, err := ctx.RegisterResource("vault:pki/secretBackendRootCert:SecretBackendRootCert", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetSecretBackendRootCert(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("vault:pki/secretBackendRootCert:SecretBackendRootCert", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &SecretBackendRootCert{s: s}, nil
