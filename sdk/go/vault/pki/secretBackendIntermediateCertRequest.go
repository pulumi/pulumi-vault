...
func NewSecretBackendIntermediateCertRequest(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("vault:pki/secretBackendIntermediateCertRequest:SecretBackendIntermediateCertRequest", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetSecretBackendIntermediateCertRequest(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("vault:pki/secretBackendIntermediateCertRequest:SecretBackendIntermediateCertRequest", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &SecretBackendIntermediateCertRequest{s: s}, nil
