...
func NewSecretBackendConfigUrls(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("vault:pki/secretBackendConfigUrls:SecretBackendConfigUrls", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetSecretBackendConfigUrls(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("vault:pki/secretBackendConfigUrls:SecretBackendConfigUrls", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &SecretBackendConfigUrls{s: s}, nil
