...
func NewSecretBackendConfigCa(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("vault:pki/secretBackendConfigCa:SecretBackendConfigCa", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetSecretBackendConfigCa(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("vault:pki/secretBackendConfigCa:SecretBackendConfigCa", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &SecretBackendConfigCa{s: s}, nil
