...
func NewAuthBackendUser(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("vault:radius/authBackendUser:AuthBackendUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthBackendUser(ctx *pulumi.Context,
	...
	var resource AuthBackendUser
	err := ctx.ReadResource("vault:radius/authBackendUser:AuthBackendUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Path to the RADIUS auth mount where the user will be registered.
func (o AuthBackendUserOutput) Mount() pulumi.StringOutput {
	return o.ApplyT(func(v *AuthBackendUser) pulumi.StringOutput { return v.Mount }).(pulumi.StringOutput)
}
