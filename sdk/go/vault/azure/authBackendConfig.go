...
//
//   - `clientSecretWo` - (Optional) The client secret for credentials to query the Azure APIs,
//     provided as a write-only field. This value will **never** be stored in Terraform state.
//     Mutually exclusive with `clientSecret`. Must be used with `clientSecretWoVersion`.
//     To rotate the secret, update the value and increment `clientSecretWoVersion`.
//
// ## Import
//
...
type AuthBackendConfig struct {
	...
	// Defaults to `60`.
	MaxRetryDelay pulumi.IntPtrOutput `pulumi:"maxRetryDelay"`
...
type authBackendConfigState struct {
	...
	// The maximum delay in seconds between retries for Azure API requests.
	// Defaults to `60`.
	MaxRetryDelay *int `pulumi:"maxRetryDelay"`
	// The namespace to provision the resource in.
	// The value should not contain leading or trailing forward slashes.
	// The `namespace` is always relative to the provider's configured [namespace](https://www.terraform.io/docs/providers/vault/index.html#namespace).
	// *Available only for Vault Enterprise*.
...
type AuthBackendConfigState struct {
	...
	// The maximum delay in seconds between retries for Azure API requests.
	// Defaults to `60`.
	MaxRetryDelay pulumi.IntPtrInput
	// The namespace to provision the resource in.
	// The value should not contain leading or trailing forward slashes.
	// The `namespace` is always relative to the provider's configured [namespace](https://www.terraform.io/docs/providers/vault/index.html#namespace).
	// *Available only for Vault Enterprise*.
...
// **NOTE:** This field is write-only and its value will not be updated in state as part of read operations.
// The client secret for credentials to query the Azure APIs. This field is write-only and will never be stored in state. Mutually exclusive with 'client_secret'. Requires 'client_secret_wo_version' to trigger updates.
func (o AuthBackendConfigOutput) ClientSecretWo() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AuthBackendConfig) pulumi.StringPtrOutput { return v.ClientSecretWo }).(pulumi.StringPtrOutput)
}

// Version counter for the write-only client secret.
// Increment this value to trigger an update of the client secret in Vault.
// Required when using `clientSecretWo`.
func (o AuthBackendConfigOutput) ClientSecretWoVersion() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *AuthBackendConfig) pulumi.IntPtrOutput { return v.ClientSecretWoVersion }).(pulumi.IntPtrOutput)
}
...
// Maximum number of retries for Azure API requests.
// Defaults to `3`.
func (o AuthBackendConfigOutput) MaxRetries() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *AuthBackendConfig) pulumi.IntPtrOutput { return v.MaxRetries }).(pulumi.IntPtrOutput)
}

// The maximum delay in seconds between retries for Azure API requests.
// Defaults to `60`.
func (o AuthBackendConfigOutput) MaxRetryDelay() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *AuthBackendConfig) pulumi.IntPtrOutput { return v.MaxRetryDelay }).(pulumi.IntPtrOutput)
}
...
// The initial delay in seconds between retries for Azure API requests.
// Defaults to `4`.
func (o AuthBackendConfigOutput) RetryDelay() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *AuthBackendConfig) pulumi.IntPtrOutput { return v.RetryDelay }).(pulumi.IntPtrOutput)
}
