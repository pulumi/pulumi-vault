...
type SecretBackendRole struct {
	...
	DefaultExtensionsTemplate pulumi.BoolPtrOutput `pulumi:"defaultExtensionsTemplate"`
	...
	ExcludeCidrLists pulumi.StringArrayOutput `pulumi:"excludeCidrLists"`
...
type secretBackendRoleState struct {
	...
	// Specifies if the `defaultExtensions` field supports templating.
	// When set to `true`, the extension values can use identity template policies. Defaults to `false`.
	DefaultExtensionsTemplate *bool `pulumi:"defaultExtensionsTemplate"`
	// Specifies the default username for which a credential will be generated.
	...
	// Specifies a comma-separated list of CIDR blocks for which credentials cannot be created.
	// This is particularly useful for OTP key types to restrict credential generation to specific network ranges.
	ExcludeCidrLists []string `pulumi:"excludeCidrLists"`
	// Specifies a custom format for the key id of a signed certificate.
...
type SecretBackendRoleState struct {
	...
	// Specifies if the `defaultExtensions` field supports templating.
	// When set to `true`, the extension values can use identity template policies. Defaults to `false`.
	DefaultExtensionsTemplate pulumi.BoolPtrInput
	// Specifies the default username for which a credential will be generated.
	...
	// Specifies a comma-separated list of CIDR blocks for which credentials cannot be created.
	// This is particularly useful for OTP key types to restrict credential generation to specific network ranges.
	ExcludeCidrLists pulumi.StringArrayInput
	// Specifies a custom format for the key id of a signed certificate.
...
// Specifies if the `defaultExtensions` field supports templating.
// When set to `true`, the extension values can use identity template policies. Defaults to `false`.
func (o SecretBackendRoleOutput) DefaultExtensionsTemplate() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *SecretBackendRole) pulumi.BoolPtrOutput { return v.DefaultExtensionsTemplate }).(pulumi.BoolPtrOutput)
}
...
// Specifies a comma-separated list of CIDR blocks for which credentials cannot be created.
// This is particularly useful for OTP key types to restrict credential generation to specific network ranges.
func (o SecretBackendRoleOutput) ExcludeCidrLists() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *SecretBackendRole) pulumi.StringArrayOutput { return v.ExcludeCidrLists }).(pulumi.StringArrayOutput)
}
...
// Specifies the port number for SSH connections. Defaults to `22`.
// This is primarily used with OTP key types to specify the SSH port on target hosts.
func (o SecretBackendRoleOutput) Port() pulumi.IntOutput {
	return o.ApplyT(func(v *SecretBackendRole) pulumi.IntOutput { return v.Port }).(pulumi.IntOutput)
}
