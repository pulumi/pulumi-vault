...
type PasswordPolicy struct {
	...
	EntropySource pulumi.StringPtrOutput `pulumi:"entropySource"`
...
type passwordPolicyState struct {
	// Specifies an override to the default source of entropy (randomness) used to generate the passwords. Must be one of: `""`, `"platform"`, or `"seal"` (Vault Enterprise only). Requires Vault 1.21+.
	EntropySource *string `pulumi:"entropySource"`
	// The name of the password policy.
...
type PasswordPolicyState struct {
	// Specifies an override to the default source of entropy (randomness) used to generate the passwords. Must be one of: `""`, `"platform"`, or `"seal"` (Vault Enterprise only). Requires Vault 1.21+.
	EntropySource pulumi.StringPtrInput
	// The name of the password policy.
...
// Specifies an override to the default source of entropy (randomness) used to generate the passwords. Must be one of: `""`, `"platform"`, or `"seal"` (Vault Enterprise only). Requires Vault 1.21+.
func (o PasswordPolicyOutput) EntropySource() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PasswordPolicy) pulumi.StringPtrOutput { return v.EntropySource }).(pulumi.StringPtrOutput)
}
