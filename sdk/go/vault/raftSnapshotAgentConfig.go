...
type RaftSnapshotAgentConfig struct {
	...
	FilePrefix pulumi.StringOutput `pulumi:"filePrefix"`
	...
	SecretsWoVersion pulumi.IntOutput `pulumi:"secretsWoVersion"`
...
// **NOTE:** This field is write-only and its value will not be updated in state as part of read operations.
// AWS secret access key. Write-only: never stored in state. If secretsWoVersion is not set, changes are automatically detected via a hash stored in private state.
func (o RaftSnapshotAgentConfigOutput) AwsSecretAccessKeyWo() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RaftSnapshotAgentConfig) pulumi.StringPtrOutput { return v.AwsSecretAccessKeyWo }).(pulumi.StringPtrOutput)
}
...
// prefix given by `pathPrefix`, the file or object name of snapshot files
// will start with this string.
func (o RaftSnapshotAgentConfigOutput) FilePrefix() pulumi.StringOutput {
	return o.ApplyT(func(v *RaftSnapshotAgentConfig) pulumi.StringOutput { return v.FilePrefix }).(pulumi.StringOutput)
}
...
// snapshot, if there are more snapshots already stored than this number, the
// oldest ones will be deleted.
func (o RaftSnapshotAgentConfigOutput) Retain() pulumi.IntOutput {
	return o.ApplyT(func(v *RaftSnapshotAgentConfig) pulumi.IntOutput { return v.Retain }).(pulumi.IntOutput)
}

// Version number for write-only secret updates. If not set, the provider automatically detects changes to write-only secrets using a SHA-256 hash stored in private state. If set manually, you control when the secret is updated by incrementing this value.
func (o RaftSnapshotAgentConfigOutput) SecretsWoVersion() pulumi.IntOutput {
	return o.ApplyT(func(v *RaftSnapshotAgentConfig) pulumi.IntOutput { return v.SecretsWoVersion }).(pulumi.IntOutput)
}
