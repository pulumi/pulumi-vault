...
// can use the auth tokens generated by this SecretID. Overrides any role-set
// value but must be a subset.
func (o AuthBackendRoleSecretIdOutput) TokenBoundCidrs() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *AuthBackendRoleSecretId) pulumi.StringArrayOutput { return v.TokenBoundCidrs }).(pulumi.StringArrayOutput)
}
