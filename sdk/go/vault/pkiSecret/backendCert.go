...
type BackendCert struct {
	s *pulumi.ResourceState
}

// NewBackendCert registers a new resource with the given unique name, arguments, and options.
func NewBackendCert(ctx *pulumi.Context,
	name string, args *BackendCertArgs, opts ...pulumi.ResourceOpt) (*BackendCert, error) {
	...
	s, err := ctx.RegisterResource("vault:pkiSecret/backendCert:BackendCert", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &BackendCert{s: s}, nil
}

// GetBackendCert gets an existing BackendCert resource's state with the given name, ID, and optional
// state properties that are used to uniquely qualify the lookup (nil if not required).
func GetBackendCert(ctx *pulumi.Context,
	name string, id pulumi.ID, state *BackendCertState, opts ...pulumi.ResourceOpt) (*BackendCert, error) {
	inputs := make(map[string]interface{})
	if state != nil {
	...
	s, err := ctx.ReadResource("vault:pkiSecret/backendCert:BackendCert", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &BackendCert{s: s}, nil
...
func (r *BackendCert) URN() *pulumi.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *BackendCert) ID() *pulumi.IDOutput {
	return r.s.ID()
}

// List of alternative names
func (r *BackendCert) AltNames() *pulumi.ArrayOutput {
	return (*pulumi.ArrayOutput)(r.s.State["altNames"])
}

// If enabled, a new certificate will be generated if the expiration is within min_seconds_remaining
func (r *BackendCert) AutoRenew() *pulumi.BoolOutput {
	return (*pulumi.BoolOutput)(r.s.State["autoRenew"])
}

// The PKI secret backend the resource belongs to.
func (r *BackendCert) Backend() *pulumi.StringOutput {
	return (*pulumi.StringOutput)(r.s.State["backend"])
}

// The CA chain
func (r *BackendCert) CaChain() *pulumi.StringOutput {
	return (*pulumi.StringOutput)(r.s.State["caChain"])
}

// The certificate
func (r *BackendCert) Certificate() *pulumi.StringOutput {
	return (*pulumi.StringOutput)(r.s.State["certificate"])
}

// CN of certificate to create
func (r *BackendCert) CommonName() *pulumi.StringOutput {
	return (*pulumi.StringOutput)(r.s.State["commonName"])
}

// Flag to exclude CN from SANs
func (r *BackendCert) ExcludeCnFromSans() *pulumi.BoolOutput {
	return (*pulumi.BoolOutput)(r.s.State["excludeCnFromSans"])
}

// The expiration date of the certificate in unix epoch format
func (r *BackendCert) Expiration() *pulumi.IntOutput {
	return (*pulumi.IntOutput)(r.s.State["expiration"])
}

// The format of data
func (r *BackendCert) Format() *pulumi.StringOutput {
	return (*pulumi.StringOutput)(r.s.State["format"])
}

// List of alternative IPs
func (r *BackendCert) IpSans() *pulumi.ArrayOutput {
	return (*pulumi.ArrayOutput)(r.s.State["ipSans"])
}

// The issuing CA
func (r *BackendCert) IssuingCa() *pulumi.StringOutput {
	return (*pulumi.StringOutput)(r.s.State["issuingCa"])
}

// Generate a new certificate when the expiration is within this number of seconds, default is 604800 (7 days)
func (r *BackendCert) MinSecondsRemaining() *pulumi.IntOutput {
	return (*pulumi.IntOutput)(r.s.State["minSecondsRemaining"])
}

// Name of the role to create the certificate against
func (r *BackendCert) Name() *pulumi.StringOutput {
	return (*pulumi.StringOutput)(r.s.State["name"])
}

// List of other SANs
func (r *BackendCert) OtherSans() *pulumi.ArrayOutput {
	return (*pulumi.ArrayOutput)(r.s.State["otherSans"])
}

// The private key
func (r *BackendCert) PrivateKey() *pulumi.StringOutput {
	return (*pulumi.StringOutput)(r.s.State["privateKey"])
}

// The private key format
func (r *BackendCert) PrivateKeyFormat() *pulumi.StringOutput {
	return (*pulumi.StringOutput)(r.s.State["privateKeyFormat"])
}

// The private key type
func (r *BackendCert) PrivateKeyType() *pulumi.StringOutput {
	return (*pulumi.StringOutput)(r.s.State["privateKeyType"])
}

// The serial number
func (r *BackendCert) SerialNumber() *pulumi.StringOutput {
	return (*pulumi.StringOutput)(r.s.State["serialNumber"])
}

// Time to live
func (r *BackendCert) Ttl() *pulumi.StringOutput {
	return (*pulumi.StringOutput)(r.s.State["ttl"])
}

// Input properties used for looking up and filtering BackendCert resources.
type BackendCertState struct {
	// List of alternative names
	AltNames interface{}
	// If enabled, a new certificate will be generated if the expiration is within min_seconds_remaining
	AutoRenew interface{}
