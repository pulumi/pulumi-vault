...
func NewSecretBackendSign(ctx *pulumi.Context,
	...
	inputs["serial"] = nil
	s, err := ctx.RegisterResource("vault:pkiSecret/secretBackendSign:SecretBackendSign", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetSecretBackendSign(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("vault:pkiSecret/secretBackendSign:SecretBackendSign", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &SecretBackendSign{s: s}, nil
