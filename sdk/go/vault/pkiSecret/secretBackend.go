...
func NewSecretBackend(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("vault:pkiSecret/secretBackend:SecretBackend", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetSecretBackend(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("vault:pkiSecret/secretBackend:SecretBackend", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &SecretBackend{s: s}, nil
