...
func NewSecretBackendIntermediateSetSigned(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("vault:pkiSecret/secretBackendIntermediateSetSigned:SecretBackendIntermediateSetSigned", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetSecretBackendIntermediateSetSigned(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("vault:pkiSecret/secretBackendIntermediateSetSigned:SecretBackendIntermediateSetSigned", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &SecretBackendIntermediateSetSigned{s: s}, nil
