...
func NewSecretBackendRootSignIntermediate(ctx *pulumi.Context,
	...
	inputs["serial"] = nil
	s, err := ctx.RegisterResource("vault:pkiSecret/secretBackendRootSignIntermediate:SecretBackendRootSignIntermediate", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetSecretBackendRootSignIntermediate(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("vault:pkiSecret/secretBackendRootSignIntermediate:SecretBackendRootSignIntermediate", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &SecretBackendRootSignIntermediate{s: s}, nil
