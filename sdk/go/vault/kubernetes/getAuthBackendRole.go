...
func LookupAuthBackendRoleOutput(ctx *pulumi.Context, args LookupAuthBackendRoleOutputArgs, opts ...pulumi.InvokeOption) LookupAuthBackendRoleResultOutput {
	...
	return ctx.InvokeOutput("vault:kubernetes/getAuthBackendRole:getAuthBackendRole", args, LookupAuthBackendRoleResultOutput{}, options).(LookupAuthBackendRoleResultOutput)
}
