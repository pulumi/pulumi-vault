...
// > **Note** This data source is replaced by "ldap.getStaticCredentials" and
...
func GetAccessCredentialsOutput(ctx *pulumi.Context, args GetAccessCredentialsOutputArgs, opts ...pulumi.InvokeOption) GetAccessCredentialsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetAccessCredentialsResultOutput, error) {
			...
			return ctx.InvokeOutput("vault:ad/getAccessCredentials:getAccessCredentials", args, GetAccessCredentialsResultOutput{}, options).(GetAccessCredentialsResultOutput), nil
