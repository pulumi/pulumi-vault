 ...
 * const example = new vault.OsSecretBackendHost("example", {
 ...
 * });
 * const osOsSecretBackend = new vault.OsSecretBackend("os", {mount: os.path});
 * const production = new vault.OsSecretBackendHost("production", {
 *     mount: osOsSecretBackend.mount,
 *     name: "prod-db-01",
 *     address: "10.0.1.50",
 *     port: 2222,
 ...
 * });
 * const osOsSecretBackend = new vault.OsSecretBackend("os", {mount: os.path});
 * const secure = new vault.OsSecretBackendHost("secure", {
 *     mount: osOsSecretBackend.mount,
 *     name: "secure-host",
 ...
 * ```
 */
export class OsSecretBackendHost extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OsSecretBackendHostState, opts?: pulumi.CustomResourceOptions): OsSecretBackendHost {
        return new OsSecretBackendHost(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:index/osSecretBackendHost:OsSecretBackendHost';

    /**
     * Returns true if the given object is an instance of OsSecretBackendHost.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is OsSecretBackendHost {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === OsSecretBackendHost.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: OsSecretBackendHostArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: OsSecretBackendHostArgs | OsSecretBackendHostState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OsSecretBackendHostState | undefined;
            ...
            const args = argsOrState as OsSecretBackendHostArgs | undefined;
        ...
        super(OsSecretBackendHost.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface OsSecretBackendHostState {
    /**
     * The address of the host (IP address or hostname).
     */
 ...
 */
export interface OsSecretBackendHostArgs {
    /**
     * The address of the host (IP address or hostname).
     */
