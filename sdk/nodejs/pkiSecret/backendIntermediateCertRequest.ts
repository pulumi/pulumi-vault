 ...
 */
export class BackendIntermediateCertRequest extends pulumi.CustomResource {
    /**
     * Get an existing BackendIntermediateCertRequest resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BackendIntermediateCertRequestState, opts?: pulumi.CustomResourceOptions): BackendIntermediateCertRequest {
        return new BackendIntermediateCertRequest(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:pkiSecret/backendIntermediateCertRequest:BackendIntermediateCertRequest';

    /**
     * Returns true if the given object is an instance of BackendIntermediateCertRequest.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is BackendIntermediateCertRequest {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === BackendIntermediateCertRequest.__pulumiType;
    }
    ...
    /**
     * Create a BackendIntermediateCertRequest resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: BackendIntermediateCertRequestArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: BackendIntermediateCertRequestArgs | BackendIntermediateCertRequestState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as BackendIntermediateCertRequestState | undefined;
            ...
            const args = argsOrState as BackendIntermediateCertRequestArgs | undefined;
        ...
        super(BackendIntermediateCertRequest.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface BackendIntermediateCertRequestState {
    /**
     * List of alternative names
     */
 ...
 */
export interface BackendIntermediateCertRequestArgs {
    /**
     * List of alternative names
     */
    readonly altNames?: pulumi.Input<pulumi.Input<string>[]>;
