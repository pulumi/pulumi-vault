 ...
 * const http = vault.getPkiExternalCaSecretBackendOrderChallengeOutput({
 *     mount: pki_external_ca.path,
 *     roleName: examplePkiExternalCaSecretBackendRole.name,
 ...
 * const tlsAlpn = vault.getPkiExternalCaSecretBackendOrderChallenge({
 *     mount: pki_external_ca.path,
 *     roleName: exampleVaultPkiExternalCaSecretBackendRole.name,
 *     orderId: example.orderId,
 ...
 */
export function getPkiExternalCaSecretBackendOrderChallenge(args: GetPkiExternalCaSecretBackendOrderChallengeArgs, opts?: pulumi.InvokeOptions): Promise<GetPkiExternalCaSecretBackendOrderChallengeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("vault:index/getPkiExternalCaSecretBackendOrderChallenge:getPkiExternalCaSecretBackendOrderChallenge", {
 ...
 */
export interface GetPkiExternalCaSecretBackendOrderChallengeArgs {
    /**
 ...
 */
export interface GetPkiExternalCaSecretBackendOrderChallengeResult {
 ...
 * > **Note** This data source polls the order status with a maximum of 5 attempts at 2-second intervals. If the order does not reach the appropriate state within this time, the data source read will fail.
 */
export function getPkiExternalCaSecretBackendOrderChallengeOutput(args: GetPkiExternalCaSecretBackendOrderChallengeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPkiExternalCaSecretBackendOrderChallengeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("vault:index/getPkiExternalCaSecretBackendOrderChallenge:getPkiExternalCaSecretBackendOrderChallenge", {
        "challengeType": args.challengeType,
        "identifier": args.identifier,
        "mount": args.mount,
        "namespace": args.namespace,
 ...
 * A collection of arguments for invoking getPkiExternalCaSecretBackendOrderChallenge.
 */
export interface GetPkiExternalCaSecretBackendOrderChallengeOutputArgs {
    /**
     * The type of ACME challenge to retrieve. Valid values are:
     * - `http-01` - HTTP challenge (requires placing a file at a specific URL)
     * - `dns-01` - DNS challenge (requires creating a TXT record)
