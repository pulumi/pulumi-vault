...
export interface AuthBackendRoleState {
    ...
    allowGceInference?: pulumi.Input<boolean | undefined>;
    /**
     * Path to the mounted GCP auth backend
     */
    backend?: pulumi.Input<string | undefined>;
    boundInstanceGroups?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    boundLabels?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * An array of GCP project IDs. Only entities belonging to this project can authenticate under the role.
     */
    boundProjects?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    boundRegions?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * GCP Service Accounts allowed to issue tokens under this role. (Note: **Required** if role is `iam`)
     */
    boundServiceAccounts?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    boundZones?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    maxJwtExp?: pulumi.Input<string | undefined>;
    /**
     * The namespace to provision the resource in.
     * The value should not contain leading or trailing forward slashes.
     * The `namespace` is always relative to the provider's configured [namespace](https://www.terraform.io/docs/providers/vault/index.html#namespace).
