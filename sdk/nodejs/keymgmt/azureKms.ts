 ...
 */
export class AzureKms extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AzureKmsState, opts?: pulumi.CustomResourceOptions): AzureKms {
        return new AzureKms(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:keymgmt/azureKms:AzureKms';

    /**
     * Returns true if the given object is an instance of AzureKms.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AzureKms {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AzureKms.__pulumiType;
    }
    ...
    /**
     * Create a AzureKms resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AzureKmsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AzureKmsArgs | AzureKmsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AzureKmsState | undefined;
            ...
            const args = argsOrState as AzureKmsArgs | undefined;
        ...
        super(AzureKms.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AzureKmsState {
    /**
     * **NOTE:** This field is write-only and its value will not be updated in state as part of read operations.
     * The credentials to use for authentication with Azure Key Vault. Supplying values for this parameter is optional, as credentials may also be specified as environment variables. Environment variables will take precedence over credentials provided via this parameter. This value is write-only and will not be stored in Terraform state.
     * The following values are supported:
