 ...
 */
export class GcpKms extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GcpKmsState, opts?: pulumi.CustomResourceOptions): GcpKms {
        return new GcpKms(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:keymgmt/gcpKms:GcpKms';

    /**
     * Returns true if the given object is an instance of GcpKms.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GcpKms {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GcpKms.__pulumiType;
    }
    ...
    /**
     * Create a GcpKms resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: GcpKmsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: GcpKmsArgs | GcpKmsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GcpKmsState | undefined;
            ...
            const args = argsOrState as GcpKmsArgs | undefined;
        ...
        super(GcpKms.__pulumiType, name, resourceInputs, opts);
    }
}
