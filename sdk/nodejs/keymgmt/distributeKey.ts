 ...
 */
export class DistributeKey extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DistributeKeyState, opts?: pulumi.CustomResourceOptions): DistributeKey {
        return new DistributeKey(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:keymgmt/distributeKey:DistributeKey';

    /**
     * Returns true if the given object is an instance of DistributeKey.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DistributeKey {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DistributeKey.__pulumiType;
    }
    ...
    /**
     * Create a DistributeKey resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DistributeKeyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DistributeKeyArgs | DistributeKeyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DistributeKeyState | undefined;
            ...
            const args = argsOrState as DistributeKeyArgs | undefined;
        ...
        super(DistributeKey.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DistributeKeyState {
    /**
     * Specifies the name of the key to distribute to the given KMS provider.
     */
 ...
 */
export interface DistributeKeyArgs {
    /**
     * Specifies the name of the key to distribute to the given KMS provider.
     */
