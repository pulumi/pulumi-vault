 ...
 * `,
 * });
 * const role = new vault.CfAuthBackendRole("role", {
 *     mount: cf.path,
 *     name: "my-role",
 ...
 */
export class CfAuthBackendRole extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CfAuthBackendRoleState, opts?: pulumi.CustomResourceOptions): CfAuthBackendRole {
        return new CfAuthBackendRole(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:index/cfAuthBackendRole:CfAuthBackendRole';

    /**
     * Returns true if the given object is an instance of CfAuthBackendRole.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CfAuthBackendRole {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CfAuthBackendRole.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: CfAuthBackendRoleArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CfAuthBackendRoleArgs | CfAuthBackendRoleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CfAuthBackendRoleState | undefined;
            ...
            const args = argsOrState as CfAuthBackendRoleArgs | undefined;
        ...
        super(CfAuthBackendRole.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface CfAuthBackendRoleState {
    /**
     * A map of string to string that will be set as metadata on the identity alias
     */
 ...
 */
export interface CfAuthBackendRoleArgs {
    /**
     * A map of string to string that will be set as metadata on the identity alias
     */
    aliasMetadata?: pulumi.Input<{[key: string]: pulumi.Input<string>} | undefined>;
