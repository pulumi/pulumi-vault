 ...
 */
export class SecretBackendOrder extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecretBackendOrderState, opts?: pulumi.CustomResourceOptions): SecretBackendOrder {
        return new SecretBackendOrder(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:pkiexternalca/secretBackendOrder:SecretBackendOrder';

    /**
     * Returns true if the given object is an instance of SecretBackendOrder.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SecretBackendOrder {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SecretBackendOrder.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: SecretBackendOrderArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SecretBackendOrderArgs | SecretBackendOrderState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SecretBackendOrderState | undefined;
            ...
            const args = argsOrState as SecretBackendOrderArgs | undefined;
        ...
        super(SecretBackendOrder.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface SecretBackendOrderState {
    /**
     * Map of identifiers to their ACME challenges (simplified representation).
     */
 ...
 */
export interface SecretBackendOrderArgs {
    /**
     * PEM-encoded Certificate Signing Request containing identifiers. Required if `identifiers` is not provided. Mutually exclusive with `identifiers`.
     */
    csr?: pulumi.Input<string | undefined>;
