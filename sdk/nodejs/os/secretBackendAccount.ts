 ...
 */
export class SecretBackendAccount extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecretBackendAccountState, opts?: pulumi.CustomResourceOptions): SecretBackendAccount {
        return new SecretBackendAccount(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'vault:os/secretBackendAccount:SecretBackendAccount';

    /**
     * Returns true if the given object is an instance of SecretBackendAccount.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SecretBackendAccount {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SecretBackendAccount.__pulumiType;
    }
    ...
    /**
     * Create a SecretBackendAccount resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SecretBackendAccountArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SecretBackendAccountArgs | SecretBackendAccountState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SecretBackendAccountState | undefined;
            ...
            const args = argsOrState as SecretBackendAccountArgs | undefined;
        ...
        super(SecretBackendAccount.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface SecretBackendAccountState {
    /**
     * Custom metadata associated with the account.
     */
 ...
 */
export interface SecretBackendAccountArgs {
    /**
     * Custom metadata associated with the account.
     */
    customMetadata?: pulumi.Input<{[key: string]: pulumi.Input<string>} | undefined>;
