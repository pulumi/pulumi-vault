...
export class RaftSnapshotAgentConfig extends pulumi.CustomResource {
     ...
     */
    declare public readonly filePrefix: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly secretsWoVersion: pulumi.Output<number>;
    /**
    ...
    constructor(name: string, argsOrState?: RaftSnapshotAgentConfigArgs | RaftSnapshotAgentConfigState, opts?: pulumi.CustomResourceOptions) {
        ...
        const secretOpts = { additionalSecretOutputs: ["awsSecretAccessKey", "awsSecretAccessKeyWo"] };
