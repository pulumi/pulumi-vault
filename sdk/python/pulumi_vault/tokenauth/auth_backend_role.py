...
class AuthBackendRole(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] bound_cidrs: If set, restricts usage of the generated token to client IPs falling within the range of the specified CIDR(s).
        :param pulumi.Input[Sequence[pulumi.Input[str]]] disallowed_policies: List of disallowed policies for given role.
        :param pulumi.Input[str] explicit_max_ttl: If set, the token will have an explicit max TTL set upon it.
        ...
        :param pulumi.Input[str] period: The duration in which a token should be renewed. At each renewal, the token's TTL will be set to the value of this parameter.
        ...
        :param pulumi.Input[str] token_type: Specifies the type of tokens that should be returned by the role. If either service or batch is specified, that kind of token will always be returned.
        """
