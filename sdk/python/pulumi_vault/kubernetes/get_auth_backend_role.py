...
def get_auth_backend_role_output(alias_metadata: pulumi.Input[Optional[Optional[Mapping[str, _builtins.str]]]] = None,
                                 audience: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                 backend: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                 namespace: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                 role_name: pulumi.Input[Optional[_builtins.str]] = None,
                                 token_bound_cidrs: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                                 token_explicit_max_ttl: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                 token_max_ttl: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                 token_no_default_policy: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                 token_num_uses: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                 token_period: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                 token_policies: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                                 token_ttl: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                 token_type: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
