...
class BackendArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] subscription_id: (`string: <required>`) - The subscription id for the Azure Active Directory.
        :param pulumi.Input[str] tenant_id: (`string: <required>`) - The tenant id for the Azure Active Directory.
        :param pulumi.Input[str] client_id: (`string:""`) - The OAuth2 client id to connect to Azure.
        :param pulumi.Input[str] client_secret: (`string:""`) - The OAuth2 client secret to connect to Azure.
        ...
        :param pulumi.Input[str] environment: (`string:""`) - The Azure environment.
        :param pulumi.Input[str] namespace: The namespace to provision the resource in.
               The value should not contain leading or trailing forward slashes.
               The `namespace` is always relative to the provider's configured [namespace](https://www.terraform.io/docs/providers/vault#namespace).
               *Available only for Vault Enterprise*.
        :param pulumi.Input[str] path: (`string: <optional>`) - The unique path this backend should be mounted at. Defaults to `azure`.
        :param pulumi.Input[bool] use_microsoft_graph_api: (`bool: <optional>`) - Indicates whether the secrets engine should use 
