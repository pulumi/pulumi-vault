...
class GetAccessCredentialsResult:
    ...
    """
    def __init__(__self__, access_key=None, backend=None, lease_duration=None, lease_id=None, lease_renewable=None, lease_start_time=None, role=None, secret_key=None, security_token=None, type=None, id=None):
...
def get_access_credentials(backend=None,role=None,type=None,opts=None):
    """
