...
__all__ = ['KeymgmtDistributeKeyArgs', 'KeymgmtDistributeKey']

@pulumi.input_type
class KeymgmtDistributeKeyArgs:
...
@pulumi.input_type
class _KeymgmtDistributeKeyState:
    def __init__(__self__, *,
...
@pulumi.type_token("vault:index/keymgmtDistributeKey:KeymgmtDistributeKey")
class KeymgmtDistributeKey(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        **Note** this feature is available only with Vault Enterprise.
        ...
        keymgmt = vault.Mount("keymgmt",
            path="keymgmt",
            type="keymgmt")
        encryption_key = vault.KeymgmtKey("encryption_key",
            mount=keymgmt.path,
            name="aws-encryption-key",
            type="aes256-gcm96")
        aws = vault.KeymgmtAwsKms("aws",
            mount=keymgmt.path,
            name="aws-kms",
        ...
        aws_dist = vault.KeymgmtDistributeKey("aws_dist",
            mount=keymgmt.path,
            kms_name=aws.name,
        ...
        signing_key = vault.KeymgmtKey("signing_key",
            mount=keymgmt["path"],
            name="azure-signing-key",
            type="rsa-2048")
        azure = vault.KeymgmtAzureKms("azure",
            mount=keymgmt["path"],
            name="azure-kv",
            ...
            credentials_wo_version=1)
        azure_dist = vault.KeymgmtDistributeKey("azure_dist",
            mount=keymgmt["path"],
            kms_name=azure.name,
        ...
        gcp_key = vault.KeymgmtKey("gcp_key",
            mount=keymgmt["path"],
            name="gcp-encryption-key",
            type="aes256-gcm96")
        gcp = vault.KeymgmtGcpKms("gcp",
            mount=keymgmt["path"],
            name="gcp-kms",
            ...
            credentials_wo_version=1)
        gcp_dist = vault.KeymgmtDistributeKey("gcp_dist",
            mount=keymgmt["path"],
            kms_name=gcp.name,
    ...
    def __init__(__self__,
        ...
        **Note** this feature is available only with Vault Enterprise.
        ...
        :param str resource_name: The name of the resource.
        :param KeymgmtDistributeKeyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KeymgmtDistributeKeyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = KeymgmtDistributeKeyArgs.__new__(KeymgmtDistributeKeyArgs)
        ...
        super(KeymgmtDistributeKey, __self__).__init__(
            'vault:index/keymgmtDistributeKey:KeymgmtDistributeKey',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            protection: pulumi.Input[Optional[_builtins.str]] = None,
            purposes: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            versions: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'KeymgmtDistributeKey':
        """
        ...
        __props__ = _KeymgmtDistributeKeyState.__new__(_KeymgmtDistributeKeyState)
        ...
        return KeymgmtDistributeKey(resource_name, opts=opts, __props__=__props__)
