...
__all__ = ['KeymgmtKeyArgs', 'KeymgmtKey']

@pulumi.input_type
class KeymgmtKeyArgs:
...
@pulumi.type_token("vault:index/keymgmtKey:KeymgmtKey")
class KeymgmtKey(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        **Note** this feature is available only with Vault Enterprise.
        ...
        keymgmt = vault.Mount("keymgmt",
            path="keymgmt",
            type="keymgmt")
        aes_key = vault.KeymgmtKey("aes_key",
            mount=keymgmt.path,
        ...
        default_key = vault.KeymgmtKey("default_key",
            mount=keymgmt["path"],
            name="my-key")
        ```
        ...
        rsa_key = vault.KeymgmtKey("rsa_key",
            mount=keymgmt["path"],
        ...
        versioned_key = vault.KeymgmtKey("versioned_key",
            mount=keymgmt["path"],
            name="versioned-key",
            type="aes256-gcm96",
        ...
        replicated_key = vault.KeymgmtKey("replicated_key",
            mount=keymgmt["path"],
    ...
    def __init__(__self__,
        ...
        **Note** this feature is available only with Vault Enterprise.
        ...
        :param str resource_name: The name of the resource.
        :param KeymgmtKeyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KeymgmtKeyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = KeymgmtKeyArgs.__new__(KeymgmtKeyArgs)
        ...
        super(KeymgmtKey, __self__).__init__(
            'vault:index/keymgmtKey:KeymgmtKey',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            namespace: pulumi.Input[Optional[_builtins.str]] = None,
            replica_regions: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None) -> 'KeymgmtKey':
        """
        ...
        __props__ = _KeymgmtKeyState.__new__(_KeymgmtKeyState)
        ...
        __props__.__dict__["replica_regions"] = replica_regions
        __props__.__dict__["type"] = type
        return KeymgmtKey(resource_name, opts=opts, __props__=__props__)
