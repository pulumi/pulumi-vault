...
__all__ = ['PkiExternalCaSecretBackendOrderArgs', 'PkiExternalCaSecretBackendOrder']

@pulumi.input_type
class PkiExternalCaSecretBackendOrderArgs:
...
@pulumi.input_type
class _PkiExternalCaSecretBackendOrderState:
    def __init__(__self__, *,
...
@pulumi.type_token("vault:index/pkiExternalCaSecretBackendOrder:PkiExternalCaSecretBackendOrder")
class PkiExternalCaSecretBackendOrder(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        > **Note** This resource creates an ACME order but does not automatically fulfill challenges or fetch the certificate. Use `get_pki_external_ca_secret_backend_order_challenge` data source to retrieve challenge details, `PkiExternalCaSecretBackendOrderChallengeFulfilled` to mark challenges as fulfilled, and `PkiExternalCaSecretBackendOrderCertificate` to fetch the final certificate.
        ...
        example_pki_external_ca_secret_backend_order = vault.PkiExternalCaSecretBackendOrder("example",
            mount=pki_external_ca.path,
            role_name=example_pki_external_ca_secret_backend_role.name,
            identifiers=[
                "www.example.com",
                "api.example.com",
            ])
        ...
        with_csr = vault.PkiExternalCaSecretBackendOrder("with_csr",
            mount=pki_external_ca["path"],
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: PkiExternalCaSecretBackendOrderArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates and manages ACME orders for certificate issuance via PKI External CA roles. This resource initiates the ACME certificate order process with an external Certificate Authority.
        ...
        :param str resource_name: The name of the resource.
        :param PkiExternalCaSecretBackendOrderArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PkiExternalCaSecretBackendOrderArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PkiExternalCaSecretBackendOrderArgs.__new__(PkiExternalCaSecretBackendOrderArgs)
        ...
        super(PkiExternalCaSecretBackendOrder, __self__).__init__(
            'vault:index/pkiExternalCaSecretBackendOrder:PkiExternalCaSecretBackendOrder',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            order_status: pulumi.Input[Optional[_builtins.str]] = None,
            role_name: pulumi.Input[Optional[_builtins.str]] = None,
            serial_number: pulumi.Input[Optional[_builtins.str]] = None) -> 'PkiExternalCaSecretBackendOrder':
        """
        ...
        __props__ = _PkiExternalCaSecretBackendOrderState.__new__(_PkiExternalCaSecretBackendOrderState)
        ...
        return PkiExternalCaSecretBackendOrder(resource_name, opts=opts, __props__=__props__)
