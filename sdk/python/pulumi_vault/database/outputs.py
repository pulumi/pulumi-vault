...
class SecretBackendConnectionCassandra(dict):
    ...
    def __init__(__self__, *,
                 ...
                 pem_bundle: Optional[builtins.str] = None,
                 pem_json: Optional[builtins.str] = None,
                 port: Optional[builtins.int] = None,
                 protocol_version: Optional[builtins.int] = None,
                 skip_verification: Optional[builtins.bool] = None,
                 tls: Optional[builtins.bool] = None,
                 username: Optional[builtins.str] = None):
        """
        :param builtins.int connect_timeout: The number of seconds to use as a connection timeout.
        :param Sequence[builtins.str] hosts: Cassandra hosts to connect to.
        :param builtins.bool insecure_tls: Whether to skip verification of the server certificate when using TLS.
        :param builtins.str password: The password to use when authenticating with Cassandra.
        :param builtins.str pem_bundle: Concatenated PEM blocks containing a certificate and private key; a certificate, private key, and issuing CA certificate; or just a CA certificate.
        :param builtins.str pem_json: Specifies JSON containing a certificate and private key; a certificate, private key, and issuing CA certificate; or just a CA certificate.
        :param builtins.int port: The transport port to use to connect to Cassandra.
        :param builtins.int protocol_version: The CQL protocol version to use.
        :param builtins.bool skip_verification: Skip permissions checks when a connection to Cassandra is first created. These checks ensure that Vault is able to create roles, but can be resource intensive in clusters with many roles.
        :param builtins.bool tls: Whether to use TLS when connecting to Cassandra.
        :param builtins.str username: The username to use when authenticating with Cassandra.
        """
    ...
    def pem_bundle(self) -> Optional[builtins.str]:
        """
    ...
    def pem_json(self) -> Optional[builtins.str]:
        """
    ...
    def protocol_version(self) -> Optional[builtins.int]:
        """
    ...
    def skip_verification(self) -> Optional[builtins.bool]:
        """
...
class SecretBackendConnectionCouchbase(dict):
    ...
    def __init__(__self__, *,
                 ...
                 base64_pem: Optional[builtins.str] = None,
                 bucket_name: Optional[builtins.str] = None,
                 insecure_tls: Optional[builtins.bool] = None,
                 tls: Optional[builtins.bool] = None,
                 username_template: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] hosts: A set of Couchbase URIs to connect to. Must use `couchbases://` scheme if `tls` is `true`.
        :param builtins.str password: Specifies the password corresponding to the given username.
        :param builtins.str username: Specifies the username for Vault to use.
        :param builtins.str base64_pem: Required if `tls` is `true`. Specifies the certificate authority of the Couchbase server, as a PEM certificate that has been base64 encoded.
        :param builtins.str bucket_name: Required for Couchbase versions prior to 6.5.0. This is only used to verify vault's connection to the server.
        :param builtins.bool insecure_tls: Specifies whether to skip verification of the server certificate when using TLS.
        :param builtins.bool tls: Specifies whether to use TLS when connecting to Couchbase.
        :param builtins.str username_template: Template describing how dynamic usernames are generated.
        """
        pulumi.set(__self__, "hosts", hosts)
        pulumi.set(__self__, "password", password)
        pulumi.set(__self__, "username", username)
    ...
    def base64_pem(self) -> Optional[builtins.str]:
        """
    ...
    def username_template(self) -> Optional[builtins.str]:
        """
...
class SecretBackendConnectionElasticsearch(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ca_path: Optional[builtins.str] = None,
                 client_cert: Optional[builtins.str] = None,
                 client_key: Optional[builtins.str] = None,
                 insecure: Optional[builtins.bool] = None,
                 tls_server_name: Optional[builtins.str] = None,
                 username_template: Optional[builtins.str] = None):
        """
        :param builtins.str password: The password to be used in the connection URL
        :param builtins.str url: The URL for Elasticsearch's API
        :param builtins.str username: The username to be used in the connection URL
        :param builtins.str ca_cert: The path to a PEM-encoded CA cert file to use to verify the Elasticsearch server's identity
        :param builtins.str ca_path: The path to a directory of PEM-encoded CA cert files to use to verify the Elasticsearch server's identity
        :param builtins.str client_cert: The path to the certificate for the Elasticsearch client to present for communication
        :param builtins.str client_key: The path to the key for the Elasticsearch client to use for communication
        :param builtins.bool insecure: Whether to disable certificate verification
        :param builtins.str tls_server_name: This, if set, is used to set the SNI host when connecting via TLS
        :param builtins.str username_template: Template describing how dynamic usernames are generated.
        """
        pulumi.set(__self__, "password", password)
    ...
    def ca_path(self) -> Optional[builtins.str]:
        """
    ...
    def tls_server_name(self) -> Optional[builtins.str]:
        """
...
class SecretBackendConnectionHana(dict):
    ...
    def __init__(__self__, *,
                 connection_url: Optional[builtins.str] = None,
                 disable_escaping: Optional[builtins.bool] = None,
                 max_connection_lifetime: Optional[builtins.int] = None,
        ...
        :param builtins.bool disable_escaping: Disable special character escaping in username and password
        :param builtins.int max_connection_lifetime: Maximum number of seconds a connection may be reused.
    ...
    def connection_url(self) -> Optional[builtins.str]:
        """
    ...
    def disable_escaping(self) -> Optional[builtins.bool]:
        """
    ...
    def max_connection_lifetime(self) -> Optional[builtins.int]:
        """
    ...
    def max_idle_connections(self) -> Optional[builtins.int]:
        """
    ...
    def max_open_connections(self) -> Optional[builtins.int]:
        """
...
class SecretBackendConnectionInfluxdb(dict):
    ...
    def __init__(__self__, *,
                 ...
                 username_template: Optional[builtins.str] = None):
        """
        :param builtins.str host: Influxdb host to connect to.
        :param builtins.str password: Specifies the password corresponding to the given username.
        :param builtins.str username: Specifies the username to use for superuser access.
        :param builtins.int connect_timeout: The number of seconds to use as a connection timeout.
        :param builtins.bool insecure_tls: Whether to skip verification of the server certificate when using TLS.
        :param builtins.str pem_bundle: Concatenated PEM blocks containing a certificate and private key; a certificate, private key, and issuing CA certificate; or just a CA certificate.
        :param builtins.str pem_json: Specifies JSON containing a certificate and private key; a certificate, private key, and issuing CA certificate; or just a CA certificate.
        :param builtins.int port: The transport port to use to connect to Influxdb.
        :param builtins.bool tls: Whether to use TLS when connecting to Influxdb.
        :param builtins.str username_template: Template describing how dynamic usernames are generated.
        """
...
class SecretBackendConnectionMongodbatlas(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str private_key: The Private Programmatic API Key used to connect with MongoDB Atlas API.
        :param builtins.str project_id: The Project ID the Database User should be created within.
        :param builtins.str public_key: The Public Programmatic API Key used to authenticate with the MongoDB Atlas API.
        """
...
class SecretBackendConnectionMssql(dict):
    ...
    def __init__(__self__, *,
                 connection_url: Optional[builtins.str] = None,
                 contained_db: Optional[builtins.bool] = None,
                 disable_escaping: Optional[builtins.bool] = None,
                 max_connection_lifetime: Optional[builtins.int] = None,
                 max_idle_connections: Optional[builtins.int] = None,
                 max_open_connections: Optional[builtins.int] = None,
        ...
        """
        :param builtins.str connection_url: Connection string to use to connect to the database.
        :param builtins.bool contained_db: Set to true when the target is a Contained Database, e.g. AzureSQL.
        :param builtins.bool disable_escaping: Disable special character escaping in username and password
        :param builtins.int max_connection_lifetime: Maximum number of seconds a connection may be reused.
        :param builtins.int max_idle_connections: Maximum number of idle connections to the database.
        :param builtins.int max_open_connections: Maximum number of open connections to the database.
    ...
    def contained_db(self) -> Optional[builtins.bool]:
        """
...
class SecretBackendConnectionMysql(dict):
    ...
    def __init__(__self__, *,
                 ...
                 username_template: Optional[builtins.str] = None):
        """
        :param builtins.str auth_type: Specify alternative authorization type. (Only 'gcp_iam' is valid currently)
        :param builtins.str connection_url: Connection string to use to connect to the database.
        :param builtins.int max_connection_lifetime: Maximum number of seconds a connection may be reused.
        :param builtins.int max_idle_connections: Maximum number of idle connections to the database.
        :param builtins.int max_open_connections: Maximum number of open connections to the database.
    ...
    def tls_ca(self) -> Optional[builtins.str]:
        """
    ...
    def tls_certificate_key(self) -> Optional[builtins.str]:
        """
...
class SecretBackendConnectionOracle(dict):
    ...
    def __init__(__self__, *,
                 connection_url: Optional[builtins.str] = None,
                 disconnect_sessions: Optional[builtins.bool] = None,
                 max_connection_lifetime: Optional[builtins.int] = None,
                 max_idle_connections: Optional[builtins.int] = None,
                 max_open_connections: Optional[builtins.int] = None,
                 password: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str connection_url: Connection string to use to connect to the database.
        :param builtins.bool disconnect_sessions: Set to true to disconnect any open sessions prior to running the revocation statements.
        :param builtins.int max_connection_lifetime: Maximum number of seconds a connection may be reused.
        :param builtins.int max_idle_connections: Maximum number of idle connections to the database.
        :param builtins.int max_open_connections: Maximum number of open connections to the database.
        :param builtins.str password: The root credential password used in the connection URL
    ...
    def disconnect_sessions(self) -> Optional[builtins.bool]:
        """
...
class SecretBackendConnectionPostgresql(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str service_account_json: A JSON encoded credential for use with IAM authorization
        :param builtins.str tls_ca: The x509 CA file for validating the certificate presented by the PostgreSQL server. Must be PEM encoded.
        :param builtins.str tls_certificate: The x509 client certificate for connecting to the database. Must be PEM encoded.
        :param builtins.str username: The root credential username used in the connection URL
        :param builtins.str username_template: Username generation template.
        """
        if auth_type is not None:
    ...
    def password_authentication(self) -> Optional[builtins.str]:
        """
    ...
    def self_managed(self) -> Optional[builtins.bool]:
        """
...
class SecretBackendConnectionRedis(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tls: Optional[builtins.bool] = None):
        """
        :param builtins.str host: Specifies the host to connect to
        :param builtins.str password: Specifies the password corresponding to the given username.
        :param builtins.str username: Specifies the username for Vault to use.
        :param builtins.str ca_cert: The contents of a PEM-encoded CA cert file to use to verify the Redis server's identity.
        :param builtins.bool insecure_tls: Specifies whether to skip verification of the server certificate when using TLS.
        :param builtins.int port: The transport port to use to connect to Redis.
        :param builtins.bool tls: Specifies whether to use TLS when connecting to Redis.
        """
        pulumi.set(__self__, "host", host)
        pulumi.set(__self__, "password", password)
        pulumi.set(__self__, "username", username)
...
class SecretBackendConnectionRedisElasticache(dict):
    def __init__(__self__, *,
                 ...
                 username: Optional[builtins.str] = None):
        """
        :param builtins.str url: The configuration endpoint for the ElastiCache cluster to connect to.
        :param builtins.str password: The AWS secret key id to use to talk to ElastiCache. If omitted the credentials chain provider is used instead.
        :param builtins.str region: The AWS region where the ElastiCache cluster is hosted. If omitted the plugin tries to infer the region from the environment.
        :param builtins.str username: The AWS access key id to use to talk to ElastiCache. If omitted the credentials chain provider is used instead.
        """
        pulumi.set(__self__, "url", url)
        if password is not None:
            pulumi.set(__self__, "password", password)
...
class SecretsMountCassandra(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 allowed_roles: Optional[Sequence[builtins.str]] = None,
                 connect_timeout: Optional[builtins.int] = None,
                 data: Optional[Mapping[str, builtins.str]] = None,
                 disable_automated_rotation: Optional[builtins.bool] = None,
                 hosts: Optional[Sequence[builtins.str]] = None,
                 insecure_tls: Optional[builtins.bool] = None,
                 password: Optional[builtins.str] = None,
                 pem_bundle: Optional[builtins.str] = None,
                 ...
                 rotation_window: Optional[builtins.int] = None,
                 skip_verification: Optional[builtins.bool] = None,
                 tls: Optional[builtins.bool] = None,
                 username: Optional[builtins.str] = None,
                 verify_connection: Optional[builtins.bool] = None):
        """
        :param builtins.str name: Name of the database connection.
        :param Sequence[builtins.str] allowed_roles: A list of roles that are allowed to use this
               connection.
        :param builtins.int connect_timeout: The number of seconds to use as a connection timeout.
        :param Mapping[str, builtins.str] data: A map of sensitive data to pass to the endpoint. Useful for templated connection strings.
        :param builtins.bool disable_automated_rotation: Cancels all upcoming rotations of the root credential until unset. Requires Vault Enterprise 1.19+.
        ...
        :param builtins.str rotation_schedule: The schedule, in [cron-style time format](https://en.wikipedia.org/wiki/Cron),
               defining the schedule on which Vault should rotate the root token. Requires Vault Enterprise 1.19+.
        :param builtins.int rotation_window: The maximum amount of time in seconds allowed to complete
               a rotation when a scheduled token rotation occurs. The default rotation window is
               unbound and the minimum allowable window is `3600`. Requires Vault Enterprise 1.19+.
        :param builtins.bool skip_verification: Skip permissions checks when a connection to Cassandra is first created. These checks ensure that Vault is able to create roles, but can be resource intensive in clusters with many roles.
        :param builtins.bool tls: Whether to use TLS when connecting to Cassandra.
        :param builtins.str username: The username to use when authenticating with Cassandra.
        :param builtins.bool verify_connection: Whether the connection should be verified on
    ...
    def allowed_roles(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def disable_automated_rotation(self) -> Optional[builtins.bool]:
        """
    ...
    def rotation_period(self) -> Optional[builtins.int]:
        """
    ...
    def rotation_schedule(self) -> Optional[builtins.str]:
        """
    ...
    def rotation_window(self) -> Optional[builtins.int]:
        """
    ...
    def verify_connection(self) -> Optional[builtins.bool]:
        """
