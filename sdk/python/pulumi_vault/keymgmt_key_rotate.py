...
__all__ = ['KeymgmtKeyRotateArgs', 'KeymgmtKeyRotate']

@pulumi.input_type
class KeymgmtKeyRotateArgs:
...
@pulumi.type_token("vault:index/keymgmtKeyRotate:KeymgmtKeyRotate")
class KeymgmtKeyRotate(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        **Note** this feature is available only with Vault Enterprise.
        ...
        encryption_key = vault.KeymgmtKey("encryption_key",
            ...
            type="aes256-gcm96")
        rotate = vault.KeymgmtKeyRotate("rotate",
            mount=keymgmt.path,
    ...
    def __init__(__self__,
        ...
        **Note** this feature is available only with Vault Enterprise.
        ...
        :param str resource_name: The name of the resource.
        :param KeymgmtKeyRotateArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KeymgmtKeyRotateArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = KeymgmtKeyRotateArgs.__new__(KeymgmtKeyRotateArgs)
        ...
        super(KeymgmtKeyRotate, __self__).__init__(
            'vault:index/keymgmtKeyRotate:KeymgmtKeyRotate',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            mount: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            namespace: pulumi.Input[Optional[_builtins.str]] = None) -> 'KeymgmtKeyRotate':
        """
        ...
        __props__ = _KeymgmtKeyRotateState.__new__(_KeymgmtKeyRotateState)

        __props__.__dict__["latest_version"] = latest_version
        __props__.__dict__["mount"] = mount
        __props__.__dict__["name"] = name
        __props__.__dict__["namespace"] = namespace
        return KeymgmtKeyRotate(resource_name, opts=opts, __props__=__props__)
