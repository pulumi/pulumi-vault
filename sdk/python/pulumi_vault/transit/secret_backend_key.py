...
class SecretBackendKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
        ...
        :param pulumi.Input[bool] exportable: Enables keys to be exportable. This allows for all the valid keys in the key ring to be exported. Once set, this cannot
               be disabled.
        :param pulumi.Input[Sequence[pulumi.Input[Mapping[str, Any]]]] keys: List of key versions in the keyring.
        :param pulumi.Input[int] latest_version: Latest key version in use in the keyring
        :param pulumi.Input[int] min_available_version: Minimum key version available for use.
        :param pulumi.Input[int] min_decryption_version: Minimum key version to use for decryption.
        :param pulumi.Input[int] min_encryption_version: Minimum key version to use for encryption
        :param pulumi.Input[str] name: Name of the encryption key to create.
