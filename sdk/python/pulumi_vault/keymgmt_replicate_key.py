...
__all__ = ['KeymgmtReplicateKeyArgs', 'KeymgmtReplicateKey']

@pulumi.input_type
class KeymgmtReplicateKeyArgs:
...
@pulumi.input_type
class _KeymgmtReplicateKeyState:
    def __init__(__self__, *,
...
@pulumi.type_token("vault:index/keymgmtReplicateKey:KeymgmtReplicateKey")
class KeymgmtReplicateKey(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        **Note** this feature is available only with Vault Enterprise and requires a configured AWS KMS provider.
        ...
        dist = vault.KeymgmtDistributeKey("dist",
            mount=keymgmt.path,
            kms_name=aws.name,
            key_name=key.name,
            purposes=[
        ...
        replicate = vault.KeymgmtReplicateKey("replicate",
            mount=keymgmt.path,
            kms_name=aws.name,
            key_name=key.name,
        ...
        **Note**: The key must have `replica_regions` configured in `KeymgmtKey` and must be distributed to the AWS KMS provider using `KeymgmtDistributeKey` before replication.
    ...
    def __init__(__self__,
        ...
        **Note**: The key must have `replica_regions` configured in `KeymgmtKey` and must be distributed to the AWS KMS provider using `KeymgmtDistributeKey` before replication.
        ...
        :param str resource_name: The name of the resource.
        :param KeymgmtReplicateKeyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KeymgmtReplicateKeyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = KeymgmtReplicateKeyArgs.__new__(KeymgmtReplicateKeyArgs)
        ...
        super(KeymgmtReplicateKey, __self__).__init__(
            'vault:index/keymgmtReplicateKey:KeymgmtReplicateKey',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            kms_name: pulumi.Input[Optional[_builtins.str]] = None,
            mount: pulumi.Input[Optional[_builtins.str]] = None,
            namespace: pulumi.Input[Optional[_builtins.str]] = None) -> 'KeymgmtReplicateKey':
        """
        ...
        __props__ = _KeymgmtReplicateKeyState.__new__(_KeymgmtReplicateKeyState)

        __props__.__dict__["key_name"] = key_name
        __props__.__dict__["kms_name"] = kms_name
        __props__.__dict__["mount"] = mount
        __props__.__dict__["namespace"] = namespace
        return KeymgmtReplicateKey(resource_name, opts=opts, __props__=__props__)
