...
__all__ = [
    'GetPkiExternalCaSecretBackendOrderChallengeResult',
    'AwaitableGetPkiExternalCaSecretBackendOrderChallengeResult',
    'get_pki_external_ca_secret_backend_order_challenge',
    'get_pki_external_ca_secret_backend_order_challenge_output',
]

@pulumi.output_type
class GetPkiExternalCaSecretBackendOrderChallengeResult:
    """
...
class AwaitableGetPkiExternalCaSecretBackendOrderChallengeResult(GetPkiExternalCaSecretBackendOrderChallengeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPkiExternalCaSecretBackendOrderChallengeResult(
...
def get_pki_external_ca_secret_backend_order_challenge(challenge_type: Optional[_builtins.str] = None,
                                                       identifier: Optional[_builtins.str] = None,
                                                       mount: Optional[_builtins.str] = None,
                                                       namespace: Optional[_builtins.str] = None,
                                                       order_id: Optional[_builtins.str] = None,
                                                       role_name: Optional[_builtins.str] = None,
                                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPkiExternalCaSecretBackendOrderChallengeResult:
    """
    ...
    http = vault.get_pki_external_ca_secret_backend_order_challenge_output(mount=pki_external_ca.path,
        role_name=example_pki_external_ca_secret_backend_role.name,
    ...
    tls_alpn = vault.get_pki_external_ca_secret_backend_order_challenge(mount=pki_external_ca["path"],
        role_name=example_vault_pki_external_ca_secret_backend_role["name"],
        order_id=example["orderId"],
    ...
    __ret__ = pulumi.runtime.invoke('vault:index/getPkiExternalCaSecretBackendOrderChallenge:getPkiExternalCaSecretBackendOrderChallenge', __args__, opts=opts, typ=GetPkiExternalCaSecretBackendOrderChallengeResult).value

    return AwaitableGetPkiExternalCaSecretBackendOrderChallengeResult(
...
def get_pki_external_ca_secret_backend_order_challenge_output(challenge_type: pulumi.Input[Optional[_builtins.str]] = None,
                                                              ...
                                                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPkiExternalCaSecretBackendOrderChallengeResult]:
    """
    Retrieves ACME challenge details for a specific identifier in an order. This data source provides the information needed to fulfill ACME challenges (HTTP-01, DNS-01, or TLS-ALPN-01) for domain validation.
    ...
    __ret__ = pulumi.runtime.invoke_output('vault:index/getPkiExternalCaSecretBackendOrderChallenge:getPkiExternalCaSecretBackendOrderChallenge', __args__, opts=opts, typ=GetPkiExternalCaSecretBackendOrderChallengeResult)
    return __ret__.apply(lambda __response__: GetPkiExternalCaSecretBackendOrderChallengeResult(
