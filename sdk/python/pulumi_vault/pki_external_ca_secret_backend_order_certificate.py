...
__all__ = ['PkiExternalCaSecretBackendOrderCertificateArgs', 'PkiExternalCaSecretBackendOrderCertificate']

@pulumi.input_type
class PkiExternalCaSecretBackendOrderCertificateArgs:
...
@pulumi.input_type
class _PkiExternalCaSecretBackendOrderCertificateState:
    def __init__(__self__, *,
...
@pulumi.type_token("vault:index/pkiExternalCaSecretBackendOrderCertificate:PkiExternalCaSecretBackendOrderCertificate")
class PkiExternalCaSecretBackendOrderCertificate(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        example_pki_external_ca_secret_backend_acme_account = vault.PkiExternalCaSecretBackendAcmeAccount("example",
        ...
        example_pki_external_ca_secret_backend_role = vault.PkiExternalCaSecretBackendRole("example",
            mount=pki_external_ca.path,
            name="example-role",
            acme_account_name=example_pki_external_ca_secret_backend_acme_account.name,
        ...
        example = vault.get_pki_external_ca_secret_backend_order_challenge_output(mount=pki_external_ca.path,
            role_name=example_pki_external_ca_secret_backend_role.name,
            order_id=example_pki_external_ca_secret_backend_order.order_id,
        ...
        example_pki_external_ca_secret_backend_order_challenge_fulfilled = vault.PkiExternalCaSecretBackendOrderChallengeFulfilled("example",
            mount=pki_external_ca.path,
            role_name=example_pki_external_ca_secret_backend_role.name,
            order_id=example_pki_external_ca_secret_backend_order.order_id,
            challenge_type="http-01",
        ...
        example_pki_external_ca_secret_backend_order_certificate = vault.PkiExternalCaSecretBackendOrderCertificate("example",
            mount=pki_external_ca.path,
            role_name=example_pki_external_ca_secret_backend_role.name,
            order_id=example_pki_external_ca_secret_backend_order.order_id,
            opts = pulumi.ResourceOptions(depends_on=[example_pki_external_ca_secret_backend_order_challenge_fulfilled]))
        pulumi.export("certificate", example_pki_external_ca_secret_backend_order_certificate.certificate)
        pulumi.export("privateKey", example_pki_external_ca_secret_backend_order_certificate.private_key)
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: PkiExternalCaSecretBackendOrderCertificateArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Polls the order status endpoint until the order is completed, then fetches the certificate. This resource waits for all ACME challenges to be validated and the certificate to be issued by the external CA.
        ...
        :param str resource_name: The name of the resource.
        :param PkiExternalCaSecretBackendOrderCertificateArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PkiExternalCaSecretBackendOrderCertificateArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PkiExternalCaSecretBackendOrderCertificateArgs.__new__(PkiExternalCaSecretBackendOrderCertificateArgs)
        ...
        super(PkiExternalCaSecretBackendOrderCertificate, __self__).__init__(
            'vault:index/pkiExternalCaSecretBackendOrderCertificate:PkiExternalCaSecretBackendOrderCertificate',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            private_key: pulumi.Input[Optional[_builtins.str]] = None,
            role_name: pulumi.Input[Optional[_builtins.str]] = None,
            serial_number: pulumi.Input[Optional[_builtins.str]] = None) -> 'PkiExternalCaSecretBackendOrderCertificate':
        """
        ...
        __props__ = _PkiExternalCaSecretBackendOrderCertificateState.__new__(_PkiExternalCaSecretBackendOrderCertificateState)
        ...
        return PkiExternalCaSecretBackendOrderCertificate(resource_name, opts=opts, __props__=__props__)
