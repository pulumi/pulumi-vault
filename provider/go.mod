...
require (
	...
	github.com/hashicorp/vault-plugin-auth-jwt v0.27.1 // indirect
	github.com/hashicorp/vault-plugin-auth-kerberos v0.18.0 // indirect
	github.com/hashicorp/vault-plugin-auth-oci v0.22.0 // indirect
